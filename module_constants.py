...
trade_goods_begin = itm.spice
trade_goods_end = itm.siege_supply
food_begin = itm.smoked_fish
food_end = itm.siege_supply
...
horses_begin = itm.sumpter_horse
horses_end = itm.arrows
weapons_begin = itm.wooden_stick
weapons_end = itm.wooden_shield
ranged_weapons_begin = itm.darts
ranged_weapons_end = itm.torch
armors_begin = itm.leather_gloves
armors_end = itm.wooden_stick
shields_begin = itm.wooden_shield
shields_end = ranged_weapons_begin

#INVASION MODE START
coop_drops_begin = itm.javelin_bow
coop_drops_end = itm.javelin_bow_ammo
coop_new_items_end = itm.ccoop_new_items_end
