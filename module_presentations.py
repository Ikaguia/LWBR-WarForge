			...
			(ti_on_presentation_load,
				[
					...
					(else_try),
						...
						(assign, ":map_image", mesh.mp_ui_host_maps_randomp),
					(else_try),
						...
						(assign, ":map_image", mesh.mp_ui_host_maps_randoms),
					(else_try),
						(assign, ":map_image", mesh.mp_ui_host_maps_randomp),
					(try_end),
	...
	("banner_selection",0,mesh.load_window,[
			(ti_on_presentation_load,
				[(set_fixed_point_multiplier, 1000),
					...
					(try_for_range, ":cur_banner_mesh", ":begin_mesh", ":try__end"),
						(create_image_button_overlay, reg1, ":cur_banner_mesh", ":cur_banner_mesh"),
						(position_set_x, pos1, ":x_pos"),
						(position_set_y, pos1, ":y_pos"),
						(overlay_set_position, reg1, pos1),
