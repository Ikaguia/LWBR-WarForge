...
presentations = [
	...
	("game_profile_banner_selection", 0, mesh.load_window, [
			(ti_on_presentation_load, [
					...
					(create_button_overlay, g.g_presentation_obj_profile_banner_selection_1, "@Next Page", tf_center_justify),
					(position_set_x, pos1, 700),
					(position_set_y, pos1, 50),
					(overlay_set_position, g.g_presentation_obj_profile_banner_selection_1, pos1),

					(create_button_overlay, g.g_presentation_obj_profile_banner_selection_2, "str_use_default_banner", tf_center_justify),
					(position_set_x, pos1, 300),
					(position_set_y, pos1, 50),
					(overlay_set_position, g.g_presentation_obj_profile_banner_selection_2, pos1),

					(assign, l.x_pos, 150),
					(assign, l.y_pos, 575),
					(store_mul, l.starting_banner, 16, g.g_presentation_page_no),
					(store_add, l.ending_banner, l.starting_banner, 16),
					(store_add, g.g_presentation_banner_start, g.g_presentation_obj_profile_banner_selection_2, 1),
					(assign, l.num_valid_banners, 0),
					(try_for_range, l.cur_banner_mesh, banner_meshes_begin, banner_meshes_end_minus_one),
						(assign, l.already_used, 0),
						(try_for_range, l.cur_faction, npc_kingdoms_begin, npc_kingdoms_end),
							(faction_slot_eq, l.cur_faction, slot_faction_banner, l.cur_banner_mesh),
							(assign, l.already_used, 1),
						(try_end),
						(eq, l.already_used, 0),
						(val_add, l.num_valid_banners, 1),
						(gt, l.num_valid_banners, l.starting_banner),
						(le, l.num_valid_banners, l.ending_banner),
						(create_image_button_overlay, reg1, l.cur_banner_mesh, l.cur_banner_mesh),
			...
			(ti_on_presentation_event_state_change, [
					...
					(try_begin),
						(eq, l.object, g.g_presentation_obj_profile_banner_selection_1),
						(val_add, g.g_presentation_page_no, 1),
						(val_mod, g.g_presentation_page_no, 8),
						(presentation_set_duration, 0),
						(start_presentation, "prsnt_game_profile_banner_selection"),
					(else_try),
						(eq, l.object, g.g_presentation_obj_profile_banner_selection_2),
						(profile_set_banner_id, -1),
						(presentation_set_duration, 0),
					(else_try),
						(store_sub, l.selected_banner, l.object, g.g_presentation_banner_start),
						(store_mul, l.page_adder, 16, g.g_presentation_page_no),
						(val_add, l.selected_banner, l.page_adder),
						(assign, l.num_valid_banners, 0),
						(assign, l.end_cond, banner_meshes_end_minus_one),
						(try_for_range, l.cur_banner_mesh, banner_meshes_begin, l.end_cond),
							(assign, l.already_used, 0),
							(try_for_range, l.cur_faction, npc_kingdoms_begin, npc_kingdoms_end),
								(faction_slot_eq, l.cur_faction, slot_faction_banner, l.cur_banner_mesh),
								(assign, l.already_used, 1),
							...
							(eq, l.already_used, 0),
							(try_begin),
								(eq, l.selected_banner, l.num_valid_banners),
								(store_sub, l.selected_banner_index, l.cur_banner_mesh, banner_meshes_begin),
								(profile_set_banner_id, l.selected_banner_index),
								(assign, l.end_cond, 0), #break
							(try_end),
							(val_add, l.num_valid_banners, 1),
						(try_end),
						(presentation_set_duration, 0),
	...
	("game_custom_battle_designer", prsntf_manual_end_only, mesh.cb_ui_main, [
			(ti_on_presentation_load,
				[(set_fixed_point_multiplier, 1000),
					...
					(try_for_range, l.cur_troop, quick_battle_troops_begin, quick_battle_troops_end),
						(str_store_troop_name, s0, l.cur_troop),
						(overlay_add_item, "$g_presentation_obj_custom_battle_designer_18", s0),
					(try_end),
					(store_sub, l.cur_troop, "$g_quick_battle_troop", quick_battle_troops_begin),
					(overlay_set_val, "$g_presentation_obj_custom_battle_designer_18", l.cur_troop),

					(store_mul, l.cur_troop, "$g_quick_battle_troop", 2), #with weapons
					(create_mesh_overlay_with_tableau_material, reg0, -1, "tableau_game_party_window", l.cur_troop),
					...
					(try_begin),
						...
						(assign, l.cur_troop, "trp_swadian_knight"),
					(else_try),
						(eq, "$g_quick_battle_team_2_faction", "fac_kingdom_2"),
						(assign, l.cur_troop, "trp_vaegir_knight"),
					(else_try),
						(eq, "$g_quick_battle_team_2_faction", "fac_kingdom_3"),
						(assign, l.cur_troop, "trp_khergit_veteran_horse_archer"),
					(else_try),
						(eq, "$g_quick_battle_team_2_faction", "fac_kingdom_4"),
						(assign, l.cur_troop, "trp_nord_champion"),
					(else_try),
						(eq, "$g_quick_battle_team_2_faction", "fac_kingdom_5"),
						(assign, l.cur_troop, "trp_rhodok_sergeant"),
					(else_try),
						(eq, "$g_quick_battle_team_2_faction", "fac_kingdom_6"),
						(assign, l.cur_troop, "trp_sarranid_mamluke"),
					(else_try),
						(assign, l.cur_troop, "trp_taiga_bandit"),
					(try_end),
					(val_mul, l.cur_troop, 2), #with weapons
					(create_mesh_overlay_with_tableau_material, reg0, -1, "tableau_game_party_window", l.cur_troop),
					...
					(store_sub, l.cur_troop_text, "$g_quick_battle_troop", quick_battle_troops_begin),
					(val_add, l.cur_troop_text, quick_battle_troop_texts_begin),
					(create_text_overlay, reg0, l.cur_troop_text, tf_scrollable),
					...
					(try_begin),
						...
						(try_for_range, l.cur_scene, quick_battle_battle_scenes_begin, quick_battle_battle_scenes_end),
							(store_sub, l.cur_scene_name, l.cur_scene, quick_battle_scenes_begin),
							(val_add, l.cur_scene_name, quick_battle_scene_names_begin),
							(overlay_add_item, "$g_presentation_obj_custom_battle_designer_1", l.cur_scene_name),
						(try_end),
						(try_begin),
							(is_between, "$g_quick_battle_map", quick_battle_battle_scenes_begin, quick_battle_battle_scenes_end),
							(store_sub, l.cur_map, "$g_quick_battle_map", quick_battle_battle_scenes_begin),
							(overlay_set_val, "$g_presentation_obj_custom_battle_designer_1", l.cur_map),
						(else_try),
							(overlay_set_val, "$g_presentation_obj_custom_battle_designer_1", 0),
							(assign, "$g_quick_battle_map", quick_battle_battle_scenes_begin),
						(try_end),
					(else_try),
						(try_for_range, l.cur_scene, quick_battle_siege_scenes_begin, quick_battle_siege_scenes_end),
							(store_sub, l.cur_scene_name, l.cur_scene, quick_battle_scenes_begin),
							(val_add, l.cur_scene_name, quick_battle_scene_names_begin),
							(overlay_add_item, "$g_presentation_obj_custom_battle_designer_1", l.cur_scene_name),
						(try_end),
						(try_begin),
							...
							(store_sub, l.cur_map, "$g_quick_battle_map", quick_battle_siege_scenes_begin),
							(overlay_set_val, "$g_presentation_obj_custom_battle_designer_1", l.cur_map),
						(else_try),
							(overlay_set_val, "$g_presentation_obj_custom_battle_designer_1", 0),
					...
					(store_sub, l.cur_mesh, "$g_quick_battle_map", quick_battle_scenes_begin),
					(val_add, l.cur_mesh, quick_battle_scene_images_begin),
					(create_mesh_overlay, reg0, l.cur_mesh),
					(position_set_x, pos1, 700),
					(position_set_y, pos1, 700),
					(overlay_set_size, reg0, pos1),
					...
					(try_begin),
						...
						(store_add, l.cur_faction, npc_kingdoms_begin, 1),
						(str_store_faction_name, s0, l.cur_faction),
						(overlay_add_item, "$g_presentation_obj_custom_battle_designer_4", s0),
					(else_try),
						(try_for_range, l.cur_faction, npc_kingdoms_begin, npc_kingdoms_end),
							(str_store_faction_name, s0, l.cur_faction),
					...
					(try_begin),
						...
						(store_sub, l.overlay_value, npc_kingdoms_end, npc_kingdoms_begin),
						(overlay_set_val, "$g_presentation_obj_custom_battle_designer_4", l.overlay_value),
					(else_try),
						(store_sub, l.team_1_faction, "$g_quick_battle_team_1_faction", npc_kingdoms_begin),
						(overlay_set_val, "$g_presentation_obj_custom_battle_designer_4", l.team_1_faction),
					(try_end),
					...
					(try_begin),
						...
						(store_sub, l.overlay_value, npc_kingdoms_end, npc_kingdoms_begin),
						(overlay_set_val, "$g_presentation_obj_custom_battle_designer_5", l.overlay_value),
					(else_try),
						(store_sub, l.team_2_faction, "$g_quick_battle_team_2_faction", npc_kingdoms_begin),
						(overlay_set_val, "$g_presentation_obj_custom_battle_designer_5", l.team_2_faction),
					(try_end),
			...
			(ti_on_presentation_event_state_change,
				[
					...
					(try_begin),
						(eq, l.object, "$g_presentation_obj_custom_battle_designer_1"),
						(try_begin),
							(eq, "$g_quick_battle_game_type", 0),
							(store_add, "$g_quick_battle_map", l.value, quick_battle_battle_scenes_begin),
						(else_try),
							(store_add, "$g_quick_battle_map", l.value, quick_battle_siege_scenes_begin),
						(try_end),
						(presentation_set_duration, 0),
						(start_presentation, "prsnt_game_custom_battle_designer"),
					(else_try),
						(eq, l.object, "$g_presentation_obj_custom_battle_designer_23"),
						(assign, "$g_quick_battle_game_type", l.value),
						(presentation_set_duration, 0),
						(start_presentation, "prsnt_game_custom_battle_designer"),
					(else_try),
						(eq, l.object, "$g_presentation_obj_custom_battle_designer_24"),
						...
						(try_begin),
							...
							(store_random_in_range, l.random_army_size, 0, 6),
							(val_add, "$g_quick_battle_army_1_size", l.random_army_size),
							(store_random_in_range, l.random_army_size, 0, 6),
							(val_add, "$g_quick_battle_army_1_size", l.random_army_size),
						(else_try),
							(store_sub, l.num_factions, npc_kingdoms_end, npc_kingdoms_begin),
							(val_add, l.num_factions, 1),
							(store_random_in_range, "$g_quick_battle_team_1_faction", 0, l.num_factions),
							(try_begin),
								(eq, "$g_quick_battle_team_1_faction", 0),
							...
							(try_end),
							(assign, l.end_cond, 1000),
							(try_for_range, l.unused, 0, l.end_cond),
								(store_random_in_range, "$g_quick_battle_team_2_faction", 0, l.num_factions),
								(try_begin),
							...
							(store_random_in_range, l.random_army_size, 0, 11),
							(val_add, "$g_quick_battle_army_1_size", l.random_army_size),
							(store_random_in_range, l.random_army_size, 0, 11),
							(val_add, "$g_quick_battle_army_1_size", l.random_army_size),
						(try_end),
						...
						(try_begin),
							...
							(store_random_in_range, l.random_type, 0, 3),
							(store_random_in_range, l.random_type_2, 0, 2),
							(store_random_in_range, l.random_composition, 0, 100),
							(store_sub, l.left_max, 100, l.random_composition),
							(store_random_in_range, l.random_composition_2, 0, l.left_max),
							(store_sub, l.random_composition_3, l.left_max, l.random_composition_2),
							(try_begin),
								(eq, l.random_type, 0),
								(assign, "$g_presentation_obj_custom_battle_designer_6_last_value", l.random_composition),
								(try_begin),
									(eq, l.random_type_2, 0),
									(assign, "$g_presentation_obj_custom_battle_designer_7_last_value", l.random_composition_2),
									(assign, "$g_presentation_obj_custom_battle_designer_8_last_value", l.random_composition_3),
								(else_try),
									(assign, "$g_presentation_obj_custom_battle_designer_8_last_value", l.random_composition_2),
									(assign, "$g_presentation_obj_custom_battle_designer_7_last_value", l.random_composition_3),
								(try_end),
							(else_try),
								(eq, l.random_type, 1),
								(assign, "$g_presentation_obj_custom_battle_designer_7_last_value", l.random_composition),
								(try_begin),
									(eq, l.random_type_2, 0),
									(assign, "$g_presentation_obj_custom_battle_designer_6_last_value", l.random_composition_2),
									(assign, "$g_presentation_obj_custom_battle_designer_8_last_value", l.random_composition_3),
								(else_try),
									(assign, "$g_presentation_obj_custom_battle_designer_8_last_value", l.random_composition_2),
									(assign, "$g_presentation_obj_custom_battle_designer_6_last_value", l.random_composition_3),
								(try_end),
							(else_try),
								(assign, "$g_presentation_obj_custom_battle_designer_8_last_value", l.random_composition),
								(try_begin),
									(eq, l.random_type_2, 0),
									(assign, "$g_presentation_obj_custom_battle_designer_6_last_value", l.random_composition_2),
									(assign, "$g_presentation_obj_custom_battle_designer_7_last_value", l.random_composition_3),
							...
							(try_begin),
								(eq, l.random_type, 0),
								(assign, "$g_presentation_obj_custom_battle_designer_9_last_value", l.random_composition),
								(try_begin),
									(eq, l.random_type_2, 0),
									(assign, "$g_presentation_obj_custom_battle_designer_10_last_value", l.random_composition_2),
									(assign, "$g_presentation_obj_custom_battle_designer_11_last_value", l.random_composition_3),
								(else_try),
									(assign, "$g_presentation_obj_custom_battle_designer_11_last_value", l.random_composition_2),
									(assign, "$g_presentation_obj_custom_battle_designer_10_last_value", l.random_composition_3),
								(try_end),
							(else_try),
								(eq, l.random_type, 1),
								(assign, "$g_presentation_obj_custom_battle_designer_10_last_value", l.random_composition),
								(try_begin),
									(eq, l.random_type_2, 0),
									(assign, "$g_presentation_obj_custom_battle_designer_9_last_value", l.random_composition_2),
									(assign, "$g_presentation_obj_custom_battle_designer_11_last_value", l.random_composition_3),
								(else_try),
									(assign, "$g_presentation_obj_custom_battle_designer_11_last_value", l.random_composition_2),
									(assign, "$g_presentation_obj_custom_battle_designer_9_last_value", l.random_composition_3),
								(try_end),
							(else_try),
								(assign, "$g_presentation_obj_custom_battle_designer_11_last_value", l.random_composition),
								(try_begin),
									(eq, l.random_type_2, 0),
									(assign, "$g_presentation_obj_custom_battle_designer_9_last_value", l.random_composition_2),
									(assign, "$g_presentation_obj_custom_battle_designer_10_last_value", l.random_composition_3),
						...
						(start_presentation, "prsnt_game_custom_battle_designer"),
					(else_try),
						(eq, l.object, "$g_presentation_obj_custom_battle_designer_2"),
						(assign, "$g_quick_battle_army_1_size", l.value),
						(try_begin),
							(is_trial_version),
					...
					(else_try),
						(eq, l.object, "$g_presentation_obj_custom_battle_designer_3"),
						(assign, "$g_quick_battle_army_2_size", l.value),
						(try_begin),
							(is_trial_version),
					...
					(else_try),
						(eq, l.object, "$g_presentation_obj_custom_battle_designer_4"),
						(try_begin),
							(store_sub, l.outlaw_index, npc_kingdoms_end, npc_kingdoms_begin),
							(eq, l.value, l.outlaw_index),
							(assign, "$g_quick_battle_team_1_faction", "fac_outlaws"),
						(else_try),
							(store_add, "$g_quick_battle_team_1_faction", l.value, npc_kingdoms_begin),
						(try_end),
					(else_try),
						(eq, l.object, "$g_presentation_obj_custom_battle_designer_5"),
						(try_begin),
							(store_sub, l.outlaw_index, npc_kingdoms_end, npc_kingdoms_begin),
							(eq, l.value, l.outlaw_index),
							(assign, "$g_quick_battle_team_2_faction", "fac_outlaws"),
						(else_try),
							(store_add, "$g_quick_battle_team_2_faction", l.value, npc_kingdoms_begin),
						(try_end),
						(presentation_set_duration, 0),
						(start_presentation, "prsnt_game_custom_battle_designer"),
					(else_try),
						(eq, l.object, "$g_presentation_obj_custom_battle_designer_18"),
						(store_add, "$g_quick_battle_troop", l.value, quick_battle_troops_begin),
						(presentation_set_duration, 0),
						(start_presentation, "prsnt_game_custom_battle_designer"),
					(else_try),
						(eq, l.object, "$g_presentation_obj_custom_battle_designer_6"),
						(try_begin),
							(eq, "$g_presentation_obj_custom_battle_designer_6_locked", 1),
							(neq, l.value, "$g_presentation_obj_custom_battle_designer_6_last_value"),
							(overlay_set_val, "$g_presentation_obj_custom_battle_designer_6", "$g_presentation_obj_custom_battle_designer_6_last_value"),
						(else_try),
							(try_begin),
								(lt, l.value, "$g_presentation_obj_custom_battle_designer_6_last_value"),
								(store_sub, l.dif, "$g_presentation_obj_custom_battle_designer_6_last_value", l.value),
								(try_begin),
									(eq, "$g_presentation_obj_custom_battle_designer_7_locked", 1),
									(assign, l.first_dif, 0),
									(assign, l.second_dif, l.dif),
								(else_try),
									(eq, "$g_presentation_obj_custom_battle_designer_8_locked", 1),
									(assign, l.first_dif, l.dif),
									(assign, l.second_dif, 0),
								(else_try),
									(store_div, l.first_dif, l.dif, 2),
									(store_sub, l.second_dif, l.dif, l.first_dif),
									(try_begin),
										(neq, l.first_dif, l.second_dif),
										(store_random_in_range, l.random_no, 0, 2),
										(eq, l.random_no, 0),
										(val_sub, l.second_dif, 1),
										(val_add, l.first_dif, 1),
									(try_end),
								(try_end),
								(assign, "$g_presentation_obj_custom_battle_designer_6_last_value", l.value),
								(val_add, "$g_presentation_obj_custom_battle_designer_7_last_value", l.first_dif),
								(val_add, "$g_presentation_obj_custom_battle_designer_8_last_value", l.second_dif),
								(try_begin),
									(gt, "$g_presentation_obj_custom_battle_designer_7_last_value", 100),
									(store_sub, l.dif, "$g_presentation_obj_custom_battle_designer_7_last_value", 100),
									(val_add, "$g_presentation_obj_custom_battle_designer_8_last_value", l.dif),
								...
								(else_try),
									...
									(store_sub, l.dif, "$g_presentation_obj_custom_battle_designer_8_last_value", 100),
									(val_add, "$g_presentation_obj_custom_battle_designer_7_last_value", l.dif),
									(assign, "$g_presentation_obj_custom_battle_designer_8_last_value", 100),
								(try_end),
								(overlay_set_val, "$g_presentation_obj_custom_battle_designer_7", "$g_presentation_obj_custom_battle_designer_7_last_value"),
								(overlay_set_val, "$g_presentation_obj_custom_battle_designer_8", "$g_presentation_obj_custom_battle_designer_8_last_value"),
							(else_try),
								(gt, l.value, "$g_presentation_obj_custom_battle_designer_6_last_value"),
								(store_sub, l.dif, l.value, "$g_presentation_obj_custom_battle_designer_6_last_value"),
								(try_begin),
									(eq, "$g_presentation_obj_custom_battle_designer_7_locked", 1),
									(assign, l.first_dif, 0),
									(assign, l.second_dif, l.dif),
								...
								(try_end),
								(assign, "$g_presentation_obj_custom_battle_designer_6_last_value", l.value),
								(val_sub, "$g_presentation_obj_custom_battle_designer_7_last_value", l.first_dif),
								(val_sub, "$g_presentation_obj_custom_battle_designer_8_last_value", l.second_dif),
								(try_begin),
						...
						(try_end),
					(else_try),
						(eq, l.object, "$g_presentation_obj_custom_battle_designer_7"),
						(try_begin),
							(eq, "$g_presentation_obj_custom_battle_designer_7_locked", 1),
							(neq, l.value, "$g_presentation_obj_custom_battle_designer_7_last_value"),
							(overlay_set_val, "$g_presentation_obj_custom_battle_designer_7", "$g_presentation_obj_custom_battle_designer_7_last_value"),
						(else_try),
							(try_begin),
								(lt, l.value, "$g_presentation_obj_custom_battle_designer_7_last_value"),
								(store_sub, l.dif, "$g_presentation_obj_custom_battle_designer_7_last_value", l.value),
								(try_begin),
									(eq, "$g_presentation_obj_custom_battle_designer_6_locked", 1),
									(assign, l.first_dif, 0),
									(assign, l.second_dif, l.dif),
								...
								(else_try),
									...
									(try_end),
								(try_end),
								(assign, "$g_presentation_obj_custom_battle_designer_7_last_value", l.value),
								(val_add, "$g_presentation_obj_custom_battle_designer_6_last_value", l.first_dif),
								(val_add, "$g_presentation_obj_custom_battle_designer_8_last_value", l.second_dif),
								(try_begin),
									(gt, "$g_presentation_obj_custom_battle_designer_6_last_value", 100),
									(store_sub, l.dif, "$g_presentation_obj_custom_battle_designer_6_last_value", 100),
									(val_add, "$g_presentation_obj_custom_battle_designer_8_last_value", l.dif),
									(assign, "$g_presentation_obj_custom_battle_designer_6_last_value", 100),
								(else_try),
									(gt, "$g_presentation_obj_custom_battle_designer_8_last_value", 100),
									(store_sub, l.dif, "$g_presentation_obj_custom_battle_designer_8_last_value", 100),
									(val_add, "$g_presentation_obj_custom_battle_designer_6_last_value", l.dif),
									(assign, "$g_presentation_obj_custom_battle_designer_8_last_value", 100),
								(try_end),
								(overlay_set_val, "$g_presentation_obj_custom_battle_designer_6", "$g_presentation_obj_custom_battle_designer_6_last_value"),
								(overlay_set_val, "$g_presentation_obj_custom_battle_designer_8", "$g_presentation_obj_custom_battle_designer_8_last_value"),
							(else_try),
								(gt, l.value, "$g_presentation_obj_custom_battle_designer_7_last_value"),
								(store_sub, l.dif, l.value, "$g_presentation_obj_custom_battle_designer_7_last_value"),
								(try_begin),
									(eq, "$g_presentation_obj_custom_battle_designer_6_locked", 1),
									(assign, l.first_dif, 0),
									(assign, l.second_dif, l.dif),
								...
								(try_end),
								(assign, "$g_presentation_obj_custom_battle_designer_7_last_value", l.value),
								(val_sub, "$g_presentation_obj_custom_battle_designer_6_last_value", l.first_dif),
								(val_sub, "$g_presentation_obj_custom_battle_designer_8_last_value", l.second_dif),
								(try_begin),
						...
						(try_end),
					(else_try),
						(eq, l.object, "$g_presentation_obj_custom_battle_designer_8"),
						(try_begin),
							(eq, "$g_presentation_obj_custom_battle_designer_8_locked", 1),
							(neq, l.value, "$g_presentation_obj_custom_battle_designer_8_last_value"),
							(overlay_set_val, "$g_presentation_obj_custom_battle_designer_8", "$g_presentation_obj_custom_battle_designer_8_last_value"),
						(else_try),
							(try_begin),
								(lt, l.value, "$g_presentation_obj_custom_battle_designer_8_last_value"),
								(store_sub, l.dif, "$g_presentation_obj_custom_battle_designer_8_last_value", l.value),
								(try_begin),
									(eq, "$g_presentation_obj_custom_battle_designer_7_locked", 1),
									(assign, l.first_dif, 0),
									(assign, l.second_dif, l.dif),
								...
								(else_try),
									...
									(try_end),
								(try_end),
								(assign, "$g_presentation_obj_custom_battle_designer_8_last_value", l.value),
								(val_add, "$g_presentation_obj_custom_battle_designer_7_last_value", l.first_dif),
								(val_add, "$g_presentation_obj_custom_battle_designer_6_last_value", l.second_dif),
								(try_begin),
									(gt, "$g_presentation_obj_custom_battle_designer_7_last_value", 100),
									(store_sub, l.dif, "$g_presentation_obj_custom_battle_designer_7_last_value", 100),
									(val_add, "$g_presentation_obj_custom_battle_designer_6_last_value", l.dif),
								...
								(overlay_set_val, "$g_presentation_obj_custom_battle_designer_6", "$g_presentation_obj_custom_battle_designer_6_last_value"),
							(else_try),
								(gt, l.value, "$g_presentation_obj_custom_battle_designer_8_last_value"),
								(store_sub, l.dif, l.value, "$g_presentation_obj_custom_battle_designer_8_last_value"),
								(try_begin),
									(eq, "$g_presentation_obj_custom_battle_designer_7_locked", 1),
									(assign, l.first_dif, 0),
									(assign, l.second_dif, l.dif),
								...
								(assign, "$g_presentation_obj_custom_battle_designer_8_last_value", l.value),
								(val_sub, "$g_presentation_obj_custom_battle_designer_7_last_value", l.first_dif),
								(val_sub, "$g_presentation_obj_custom_battle_designer_6_last_value", l.second_dif),
								(try_begin),
									(lt, "$g_presentation_obj_custom_battle_designer_7_last_value", 0),
						...
						(try_end),
					(else_try),
						(eq, l.object, "$g_presentation_obj_custom_battle_designer_9"),
						(try_begin),
							(eq, "$g_presentation_obj_custom_battle_designer_9_locked", 1),
							(neq, l.value, "$g_presentation_obj_custom_battle_designer_9_last_value"),
							(overlay_set_val, "$g_presentation_obj_custom_battle_designer_9", "$g_presentation_obj_custom_battle_designer_9_last_value"),
						(else_try),
							(try_begin),
								(lt, l.value, "$g_presentation_obj_custom_battle_designer_9_last_value"),
								(store_sub, l.dif, "$g_presentation_obj_custom_battle_designer_9_last_value", l.value),
								(try_begin),
								...
								(else_try),
									...
									(try_end),
								(try_end),
								(assign, "$g_presentation_obj_custom_battle_designer_9_last_value", l.value),
								(val_add, "$g_presentation_obj_custom_battle_designer_10_last_value", l.first_dif),
								(val_add, "$g_presentation_obj_custom_battle_designer_11_last_value", l.second_dif),
								(try_begin),
									(gt, "$g_presentation_obj_custom_battle_designer_10_last_value", 100),
									(store_sub, l.dif, "$g_presentation_obj_custom_battle_designer_10_last_value", 100),
									(val_add, "$g_presentation_obj_custom_battle_designer_11_last_value", l.dif),
								...
								(else_try),
									...
									(store_sub, l.dif, "$g_presentation_obj_custom_battle_designer_11_last_value", 100),
									(val_add, "$g_presentation_obj_custom_battle_designer_10_last_value", l.dif),
									(assign, "$g_presentation_obj_custom_battle_designer_11_last_value", 100),
								(try_end),
								(overlay_set_val, "$g_presentation_obj_custom_battle_designer_10", "$g_presentation_obj_custom_battle_designer_10_last_value"),
								(overlay_set_val, "$g_presentation_obj_custom_battle_designer_11", "$g_presentation_obj_custom_battle_designer_11_last_value"),
							(else_try),
								(gt, l.value, "$g_presentation_obj_custom_battle_designer_9_last_value"),
								(store_sub, l.dif, l.value, "$g_presentation_obj_custom_battle_designer_9_last_value"),
								(try_begin),
									(eq, "$g_presentation_obj_custom_battle_designer_10_locked", 1),
									(assign, l.first_dif, 0),
									(assign, l.second_dif, l.dif),
								...
								(try_end),
								(assign, "$g_presentation_obj_custom_battle_designer_9_last_value", l.value),
								(val_sub, "$g_presentation_obj_custom_battle_designer_10_last_value", l.first_dif),
								(val_sub, "$g_presentation_obj_custom_battle_designer_11_last_value", l.second_dif),
								(try_begin),
						...
						(try_end),
					(else_try),
						(eq, l.object, "$g_presentation_obj_custom_battle_designer_10"),
						(try_begin),
							(eq, "$g_presentation_obj_custom_battle_designer_10_locked", 1),
							(neq, l.value, "$g_presentation_obj_custom_battle_designer_10_last_value"),
							(overlay_set_val, "$g_presentation_obj_custom_battle_designer_10", "$g_presentation_obj_custom_battle_designer_10_last_value"),
						(else_try),
							(try_begin),
								(lt, l.value, "$g_presentation_obj_custom_battle_designer_10_last_value"),
								(store_sub, l.dif, "$g_presentation_obj_custom_battle_designer_10_last_value", l.value),
								(try_begin),
									(eq, "$g_presentation_obj_custom_battle_designer_9_locked", 1),
									(assign, l.first_dif, 0),
									(assign, l.second_dif, l.dif),
								...
								(else_try),
									...
									(try_end),
								(try_end),
								(assign, "$g_presentation_obj_custom_battle_designer_10_last_value", l.value),
								(val_add, "$g_presentation_obj_custom_battle_designer_9_last_value", l.first_dif),
								(val_add, "$g_presentation_obj_custom_battle_designer_11_last_value", l.second_dif),
								(try_begin),
									(gt, "$g_presentation_obj_custom_battle_designer_9_last_value", 100),
									(store_sub, l.dif, "$g_presentation_obj_custom_battle_designer_9_last_value", 100),
									(val_add, "$g_presentation_obj_custom_battle_designer_11_last_value", l.dif),
									(assign, "$g_presentation_obj_custom_battle_designer_9_last_value", 100),
								(else_try),
									(gt, "$g_presentation_obj_custom_battle_designer_11_last_value", 100),
									(store_sub, l.dif, "$g_presentation_obj_custom_battle_designer_11_last_value", 100),
									(val_add, "$g_presentation_obj_custom_battle_designer_9_last_value", l.dif),
									(assign, "$g_presentation_obj_custom_battle_designer_11_last_value", 100),
								(try_end),
								(overlay_set_val, "$g_presentation_obj_custom_battle_designer_9", "$g_presentation_obj_custom_battle_designer_9_last_value"),
								(overlay_set_val, "$g_presentation_obj_custom_battle_designer_11", "$g_presentation_obj_custom_battle_designer_11_last_value"),
							(else_try),
								(gt, l.value, "$g_presentation_obj_custom_battle_designer_10_last_value"),
								(store_sub, l.dif, l.value, "$g_presentation_obj_custom_battle_designer_10_last_value"),
								(try_begin),
									(eq, "$g_presentation_obj_custom_battle_designer_9_locked", 1),
									(assign, l.first_dif, 0),
									(assign, l.second_dif, l.dif),
								...
								(try_end),
								(assign, "$g_presentation_obj_custom_battle_designer_10_last_value", l.value),
								(val_sub, "$g_presentation_obj_custom_battle_designer_9_last_value", l.first_dif),
								(val_sub, "$g_presentation_obj_custom_battle_designer_11_last_value", l.second_dif),
								(try_begin),
						...
						(try_end),
					(else_try),
						(eq, l.object, "$g_presentation_obj_custom_battle_designer_11"),
						(try_begin),
							(eq, "$g_presentation_obj_custom_battle_designer_11_locked", 1),
							(neq, l.value, "$g_presentation_obj_custom_battle_designer_11_last_value"),
							(overlay_set_val, "$g_presentation_obj_custom_battle_designer_11", "$g_presentation_obj_custom_battle_designer_11_last_value"),
						(else_try),
							(try_begin),
								(lt, l.value, "$g_presentation_obj_custom_battle_designer_11_last_value"),
								(store_sub, l.dif, "$g_presentation_obj_custom_battle_designer_11_last_value", l.value),
								(try_begin),
									(eq, "$g_presentation_obj_custom_battle_designer_10_locked", 1),
									(assign, l.first_dif, 0),
									(assign, l.second_dif, l.dif),
								...
								(else_try),
									...
									(try_end),
								(try_end),
								(assign, "$g_presentation_obj_custom_battle_designer_11_last_value", l.value),
								(val_add, "$g_presentation_obj_custom_battle_designer_10_last_value", l.first_dif),
								(val_add, "$g_presentation_obj_custom_battle_designer_9_last_value", l.second_dif),
								(try_begin),
									(gt, "$g_presentation_obj_custom_battle_designer_10_last_value", 100),
									(store_sub, l.dif, "$g_presentation_obj_custom_battle_designer_10_last_value", 100),
									(val_add, "$g_presentation_obj_custom_battle_designer_9_last_value", l.dif),
								...
								(overlay_set_val, "$g_presentation_obj_custom_battle_designer_9", "$g_presentation_obj_custom_battle_designer_9_last_value"),
							(else_try),
								(gt, l.value, "$g_presentation_obj_custom_battle_designer_11_last_value"),
								(store_sub, l.dif, l.value, "$g_presentation_obj_custom_battle_designer_11_last_value"),
								(try_begin),
									(eq, "$g_presentation_obj_custom_battle_designer_10_locked", 1),
									(assign, l.first_dif, 0),
									(assign, l.second_dif, l.dif),
								...
								(assign, "$g_presentation_obj_custom_battle_designer_11_last_value", l.value),
								(val_sub, "$g_presentation_obj_custom_battle_designer_10_last_value", l.first_dif),
								(val_sub, "$g_presentation_obj_custom_battle_designer_9_last_value", l.second_dif),
								(try_begin),
									(lt, "$g_presentation_obj_custom_battle_designer_10_last_value", 0),
						...
						(try_end),
					(else_try),
						(eq, l.object, "$g_presentation_obj_custom_battle_designer_19"),
						(assign, "$g_is_quick_battle", 1),
						(assign, l.cur_scene, "$g_quick_battle_map"),
						(try_begin),
							(eq, "$g_quick_battle_game_type", 0), #battle
							(assign, l.cur_mission_template, "mt_quick_battle_battle"),
							(modify_visitors_at_site, l.cur_scene),
						...
						(else_try),
							(eq, "$g_quick_battle_game_type", 1), #siege offense
							(assign, l.cur_mission_template, "mt_quick_battle_siege"),
							(modify_visitors_at_site, l.cur_scene),
						...
						(else_try),
							...
							(call_script, "script_spawn_quick_battle_army", 16, "$g_quick_battle_team_2_faction", "$g_presentation_obj_custom_battle_designer_9_last_value", "$g_presentation_obj_custom_battle_designer_10_last_value", "$g_presentation_obj_custom_battle_designer_11_last_value", 0, 0),
						(try_end),
						(set_jump_mission,l.cur_mission_template),
						(jump_to_menu, "mnu_custom_battle_end"),
						(jump_to_scene, l.cur_scene),
						(change_screen_mission),
						(presentation_set_duration, 0),
					(else_try),
						(eq, l.object, "$g_presentation_obj_custom_battle_designer_20"),
						(presentation_set_duration, 0),
					(try_end),
					]),
			(ti_on_presentation_mouse_enter_leave,
				[
					(store_trigger_param_1, l.object),
					(store_trigger_param_2, l.enter_leave),
					(this_or_next|eq, l.object, "$g_presentation_obj_custom_battle_designer_6"),
					(this_or_next|eq, l.object, "$g_presentation_obj_custom_battle_designer_7"),
					(this_or_next|eq, l.object, "$g_presentation_obj_custom_battle_designer_8"),
					(this_or_next|eq, l.object, "$g_presentation_obj_custom_battle_designer_9"),
					(this_or_next|eq, l.object, "$g_presentation_obj_custom_battle_designer_10"),
					(eq, l.object, "$g_presentation_obj_custom_battle_designer_11"),
					(try_begin),
						(eq, l.enter_leave, 1),
						(try_begin),
							(eq, l.object, "$g_presentation_obj_custom_battle_last_mouse_over_object"),
							(assign, "$g_presentation_obj_custom_battle_last_mouse_over_object", -1),
						(try_end),
					(else_try),
						(assign, "$g_presentation_obj_custom_battle_last_mouse_over_object", l.object),
					(try_end),
					]),
			(ti_on_presentation_run,
				[
	...
	("game_multiplayer_admin_panel", prsntf_manual_end_only, 0, [
			(ti_on_presentation_load,
				[
					...
					(else_try),
						...
						(assign, l.map_image, mesh.mp_ui_host_maps_randomp),
					(else_try),
						...
						(assign, l.map_image, mesh.mp_ui_host_maps_randoms),
					(else_try),
						(assign, l.map_image, mesh.mp_ui_host_maps_randomp),
					(try_end),

					(create_mesh_overlay, reg0, l.map_image),
					...
					(try_begin),
						...
						(val_add, l.cur_y, l.cur_y_adder), #two more options for these mods (friendly fire options)
						(val_add, l.cur_y, l.cur_y_adder),
						(this_or_next|eq, "$g_multiplayer_game_type", multiplayer_game_type_capture_the_flag),
						(this_or_next|eq, "$g_multiplayer_game_type", multiplayer_game_type_battle),
						(this_or_next|eq, "$g_multiplayer_game_type", multiplayer_game_type_destroy),
						(eq, "$g_multiplayer_game_type", multiplayer_game_type_siege),
						(val_add, l.cur_y, l.cur_y_adder), #one more option for these mods
						(this_or_next|eq, "$g_multiplayer_game_type", multiplayer_game_type_battle),
						(this_or_next|eq, "$g_multiplayer_game_type", multiplayer_game_type_destroy),
						(eq, "$g_multiplayer_game_type", multiplayer_game_type_siege),
						(val_add, l.cur_y, l.cur_y_adder), #one more option for these mods
					...
					(try_begin),
						...
						(val_sub, l.cur_y, l.cur_y_adder), #-2 options but +2
					(try_end),
					(try_begin),
					...
					(create_check_box_overlay, "$g_presentation_obj_admin_panel_14", mesh.checkbox_off, mesh.checkbox_on),
					(position_set_x, pos1, 7),
					(store_add, l.special_cur_y, l.cur_y, 7),
					(position_set_y, pos1, l.special_cur_y),
					(overlay_set_position, "$g_presentation_obj_admin_panel_14", pos1),
					(server_get_add_to_game_servers_list, l.add_to_servers_list),
					(overlay_set_val, "$g_presentation_obj_admin_panel_14", l.add_to_servers_list),
					...
					(create_check_box_overlay, "$g_presentation_obj_admin_panel_41", mesh.checkbox_off, mesh.checkbox_on),
					(position_set_x, pos1, 7),
					(store_add, l.special_cur_y, l.cur_y, 7),
					(position_set_y, pos1, l.special_cur_y),
					...
					(assign, l.num_maps, reg0),
					(assign, l.selected_index, 0),
					...
					(troop_get_slot, l.first_map, "trp_multiplayer_data", multi_data_maps_for_game_type_begin),
					(assign, l.selected_map_available, 0),
					(try_for_range, l.i_map, 0, l.num_maps),
						(store_add, l.map_slot, l.i_map, multi_data_maps_for_game_type_begin),
						(troop_get_slot, l.map_no, "trp_multiplayer_data", l.map_slot),
						(store_sub, l.string_index, l.map_no, multiplayer_scenes_begin),
						(val_add, l.string_index, multiplayer_scene_names_begin),
						(str_store_string, s0, l.string_index),
						(overlay_add_item, "$g_presentation_obj_admin_panel_1", s0),
						(try_begin),
							(eq, l.map_no, "$g_multiplayer_selected_map"),
							(assign, l.selected_index, l.i_map),
							(assign, l.selected_map_available, 1),
						(try_end),
					(try_end),
					(overlay_set_val, "$g_presentation_obj_admin_panel_1", l.selected_index),
					...
					(try_begin),
						...
						(try_for_range, l.i_game_type, 0, multiplayer_num_game_types),
							(store_add, l.string_index, l.i_game_type, multiplayer_game_type_names_begin),
							(str_store_string, s0, l.string_index),
					...
					(else_try),
						(assign, "$g_presentation_obj_admin_panel_10", -1),
						(store_add, l.string_index, "$g_multiplayer_game_type", multiplayer_game_type_names_begin),
						(str_store_string, s0, l.string_index),
						(create_text_overlay, reg0, s0, 0),
						(position_set_x, pos1, 385),
						(position_set_y, pos1, l.cur_y),
					...
					(try_begin),
						(eq, "$g_multiplayer_game_type", multiplayer_game_type_captain_coop),
						(store_add, l.coop_max_number_players_high_range, ccoop_max_num_players, 1),
						(create_number_box_overlay, "$g_presentation_obj_admin_panel_21", 2, l.coop_max_number_players_high_range), # range is [2,8] for ccoop
						# clamp max_num_players
						(try_begin),
							(server_get_max_num_players, l.max_num_players),
							(gt, l.max_num_players, ccoop_max_num_players),
					...
					(server_get_max_num_players, l.max_players),
					(overlay_set_val, "$g_presentation_obj_admin_panel_21", l.max_players),
					...
					(try_begin),
						...
						(create_check_box_overlay, "$g_presentation_obj_admin_panel_5", mesh.checkbox_off, mesh.checkbox_on),
						(position_set_x, pos1, 7),
						(store_add, l.special_cur_y, l.cur_y, 7),
						(position_set_y, pos1, l.special_cur_y),
						(overlay_set_position, "$g_presentation_obj_admin_panel_5", pos1),
						(server_get_friendly_fire, l.server_friendly_fire),
						(overlay_set_val, "$g_presentation_obj_admin_panel_5", l.server_friendly_fire),
						...
						(create_check_box_overlay, "$g_presentation_obj_admin_panel_36", mesh.checkbox_off, mesh.checkbox_on),
						(position_set_x, pos1, 7),
						(store_add, l.special_cur_y, l.cur_y, 7),
						(position_set_y, pos1, l.special_cur_y),
						(overlay_set_position, "$g_presentation_obj_admin_panel_36", pos1),
						(server_get_melee_friendly_fire, l.melee_friendly_fire),
						(overlay_set_val, "$g_presentation_obj_admin_panel_36", l.melee_friendly_fire),
					(try_end),
					...
					(server_get_friendly_fire_damage_self_ratio, l.friendly_fire_damage_self_ratio),
					(overlay_set_val, "$g_presentation_obj_admin_panel_37", l.friendly_fire_damage_self_ratio),
					...
					(server_get_friendly_fire_damage_friend_ratio, l.friendly_fire_damage_friend_ratio),
					(overlay_set_val, "$g_presentation_obj_admin_panel_38", l.friendly_fire_damage_friend_ratio),
					...
					(server_get_ghost_mode, l.server_ghost_mode),
					(overlay_set_val, "$g_presentation_obj_admin_panel_19", l.server_ghost_mode),
					...
					(server_get_control_block_dir, l.server_control_block_dir),
					(overlay_set_val, "$g_presentation_obj_admin_panel_15", l.server_control_block_dir),
					...
					(server_get_combat_speed, l.server_combat_speed),
					(overlay_set_val, "$g_presentation_obj_admin_panel_26", l.server_combat_speed),
					...
					(try_begin),
						...
						(create_check_box_overlay, "$g_presentation_obj_admin_panel_25", mesh.checkbox_off, mesh.checkbox_on),
						(position_set_x, pos1, 7),
						(store_add, l.special_cur_y, l.cur_y, 7),
						(position_set_y, pos1, l.special_cur_y),
					...
					(try_begin),
						...
						(store_sub, l.value_to_set, 5, "$g_multiplayer_number_of_respawn_count"),
						(overlay_set_val, "$g_presentation_obj_admin_panel_27", l.value_to_set),
						#(val_sub, l.cur_y, l.cur_y_adder),
					(else_try),
						(assign, "$g_presentation_obj_admin_panel_27", -1),
					(try_end),
					...
					(create_check_box_overlay, "$g_presentation_obj_admin_panel_28", mesh.checkbox_off, mesh.checkbox_on),
					(position_set_x, pos1, 7),
					(store_add, l.special_cur_y, l.cur_y, 7),
					(position_set_y, pos1, l.special_cur_y),
					...
					(create_check_box_overlay, "$g_presentation_obj_admin_panel_29", mesh.checkbox_off, mesh.checkbox_on),
					(position_set_x, pos1, 7),
					(store_add, l.special_cur_y, l.cur_y, 7),
					(position_set_y, pos1, l.special_cur_y),
					...
					(create_check_box_overlay, "$g_presentation_obj_admin_panel_24", mesh.checkbox_off, mesh.checkbox_on),
					(position_set_x, pos1, 7),
					(store_add, l.special_cur_y, l.cur_y, 7),
					(position_set_y, pos1, l.special_cur_y),
					...
					(create_check_box_overlay, "$g_presentation_obj_admin_panel_23", mesh.checkbox_off, mesh.checkbox_on),
					(position_set_x, pos1, 7),
					(store_add, l.special_cur_y, l.cur_y, 7),
					(position_set_y, pos1, l.special_cur_y),
					...
					(try_begin), #ccoop bot count limit for polls
						...
						(assign, l.upper_limit, 51),
						(val_min, l.upper_limit, "$g_multiplayer_max_num_bots"),
						(create_number_box_overlay, "$g_presentation_obj_admin_panel_22", 0, l.upper_limit),
						(position_set_x, pos1, 390),
						(position_set_y, pos1, l.cur_y),
					...
					(try_begin), # auto team balance
						...
						(else_try),
							(store_sub,l.set_value, 7, "$g_multiplayer_auto_team_balance_limit"),
							(overlay_set_val, "$g_presentation_obj_admin_panel_31",l.set_value),
						(try_end),
					...
					(create_check_box_overlay, "$g_presentation_obj_admin_panel_39", mesh.checkbox_off, mesh.checkbox_on),
					(position_set_x, pos1, 7),
					(store_add, l.special_cur_y, l.cur_y, 7),
					(position_set_y, pos1, l.special_cur_y),
					...
					(create_check_box_overlay, "$g_presentation_obj_admin_panel_42", mesh.checkbox_off, mesh.checkbox_on),
					(position_set_x, pos1, 7),
					(store_add, l.special_cur_y, l.cur_y, 7),
					(position_set_y, pos1, l.special_cur_y),
					...
					(create_check_box_overlay, "$g_presentation_obj_admin_panel_40", mesh.checkbox_off, mesh.checkbox_on),
					(position_set_x, pos1, 7),
					(store_add, l.special_cur_y, l.cur_y, 7),
					(position_set_y, pos1, l.special_cur_y),
					...
					(try_begin),
						(eq, l.selected_map_available, 0),
						(assign, "$g_multiplayer_selected_map", l.first_map),
						(presentation_set_duration, 0),
			...
			(ti_on_presentation_event_state_change,
				[
					...
					(store_trigger_param_2, l.value),
					(try_begin),
						(eq, l.object, "$g_presentation_obj_admin_panel_1"),
						(store_add, l.slot_no, l.value, multi_data_maps_for_game_type_begin),
						(troop_get_slot, "$g_multiplayer_selected_map", "trp_multiplayer_data", l.slot_no),
						(presentation_set_duration, 0),
						(start_presentation, "prsnt_game_multiplayer_admin_panel"),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_2"),
						(multiplayer_send_2_int_to_server, multiplayer_event_admin_start_map, "$g_multiplayer_selected_map", "$g_multiplayer_game_type"),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_3"),
						(multiplayer_send_2_int_to_server, multiplayer_event_admin_set_num_bots_in_team, 1, l.value),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_4"),
						(multiplayer_send_2_int_to_server, multiplayer_event_admin_set_num_bots_in_team, 2, l.value),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_5"),
						(multiplayer_send_int_to_server, multiplayer_event_admin_set_friendly_fire, l.value),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_6"),
						(multiplayer_send_int_to_server, multiplayer_event_admin_set_respawn_period, l.value),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_7"),
						(multiplayer_send_int_to_server, multiplayer_event_admin_set_game_max_minutes, l.value),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_8"),
						(multiplayer_send_int_to_server, multiplayer_event_admin_set_game_max_points, l.value),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_9"),
						(multiplayer_send_string_to_server, multiplayer_event_admin_set_game_password, s0),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_10"),
						(assign, "$g_multiplayer_game_type", l.value),
						#INVASION MODE START
						...
						(start_presentation, "prsnt_game_multiplayer_admin_panel"),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_11"),
						(store_add, "$g_multiplayer_next_team_1_faction", l.value, npc_kingdoms_begin),
						##        (try_begin),
						...
						(start_presentation, "prsnt_game_multiplayer_admin_panel"),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_12"),
						#INVASION MODE START
						(try_begin),
							(eq, l.value, 6),
						...
						(else_try),
							(store_add, "$g_multiplayer_next_team_2_faction", l.value, npc_kingdoms_begin),
						(try_end),
						#INVASION MODE END
						##        (try_begin),
						...
						(start_presentation, "prsnt_game_multiplayer_admin_panel"),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_13"),
						(presentation_set_duration, 0),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_14"),
						(multiplayer_send_int_to_server, multiplayer_event_admin_set_add_to_servers_list, l.value),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_15"),
						(multiplayer_send_int_to_server, multiplayer_event_admin_set_control_block_dir, l.value),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_16"),
						(multiplayer_send_int_to_server, multiplayer_event_admin_set_round_max_seconds, l.value),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_17"),
						(multiplayer_send_int_to_server, multiplayer_event_admin_set_point_gained_from_flags, l.value),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_18"),
						(multiplayer_send_int_to_server, multiplayer_event_admin_set_point_gained_from_capturing_flag, l.value),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_19"),
						(multiplayer_send_int_to_server, multiplayer_event_admin_set_ghost_mode, l.value),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_20"),
						(multiplayer_send_string_to_server, multiplayer_event_admin_set_server_name, s0),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_21"),
						(multiplayer_send_int_to_server, multiplayer_event_admin_set_max_num_players, l.value),
						#INVASION MODE START
						#(tutorial_message, -1),
						(try_begin),
							(eq, "$g_multiplayer_is_game_type_captain", 1),
						...
						#INVASION MODE END
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_22"),
						(multiplayer_send_int_to_server, multiplayer_event_admin_set_num_bots_voteable, l.value),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_23"),
						(multiplayer_send_int_to_server, multiplayer_event_admin_set_factions_voteable, l.value),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_24"),
						(multiplayer_send_int_to_server, multiplayer_event_admin_set_maps_voteable, l.value),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_25"),
						(multiplayer_send_int_to_server, multiplayer_event_admin_set_player_respawn_as_bot, l.value),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_26"),
						(multiplayer_send_int_to_server, multiplayer_event_admin_set_combat_speed, l.value),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_27"),
						(store_sub, l.value_to_send, 5, l.value), #opposite index of displayed list
						(multiplayer_send_int_to_server, multiplayer_event_admin_set_respawn_count, l.value_to_send),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_28"),
						(multiplayer_send_int_to_server, multiplayer_event_admin_set_kick_voteable, l.value),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_29"),
						(multiplayer_send_int_to_server, multiplayer_event_admin_set_ban_voteable, l.value),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_30"),
						(multiplayer_send_int_to_server, multiplayer_event_admin_set_valid_vote_ratio, l.value),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_31"),
						(try_begin),
							(eq, l.value, 0),
							(multiplayer_send_int_to_server, multiplayer_event_admin_set_auto_team_balance_limit, 1000),
						(else_try),
							(store_sub, l.value_to_send, 7, l.value),
							(multiplayer_send_int_to_server, multiplayer_event_admin_set_auto_team_balance_limit, l.value_to_send),
						(try_end),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_32"),
						(server_set_welcome_message, s0),
						(multiplayer_send_string_to_server, multiplayer_event_admin_set_welcome_message, s0),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_33"),
						(multiplayer_send_int_to_server, multiplayer_event_admin_set_initial_gold_multiplier, l.value),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_34"),
						(multiplayer_send_int_to_server, multiplayer_event_admin_set_battle_earnings_multiplier, l.value),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_35"),
						(multiplayer_send_int_to_server, multiplayer_event_admin_set_round_earnings_multiplier, l.value),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_36"),
						(multiplayer_send_int_to_server, multiplayer_event_admin_set_melee_friendly_fire, l.value),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_37"),
						(multiplayer_send_int_to_server, multiplayer_event_admin_set_friendly_fire_damage_self_ratio, l.value),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_38"),
						(multiplayer_send_int_to_server, multiplayer_event_admin_set_friendly_fire_damage_friend_ratio, l.value),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_39"),
						(multiplayer_send_int_to_server, multiplayer_event_admin_set_allow_player_banners, l.value),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_40"),
						(multiplayer_send_int_to_server, multiplayer_event_admin_set_force_default_armor, l.value),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_41"),
						(multiplayer_send_int_to_server, multiplayer_event_admin_set_anti_cheat, l.value),
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_42"),
						(multiplayer_send_int_to_server, multiplayer_event_admin_set_disallow_ranged_weapons, l.value),
						#INVASION MODE START
					(else_try),
						(eq, l.object, "$g_presentation_obj_admin_panel_43"),
						(assign, "$g_multiplayer_ccoop_difficulty", l.value),
						(multiplayer_send_2_int_to_server, multiplayer_event_other_events, multiplayer_event_admin_set_ccoop_difficulty, l.value),
			...
			(ti_on_presentation_load,
				[(set_fixed_point_multiplier, 1000),
					...
					(else_try),
						...
						(store_mission_timer_a, l.mission_timer),
						(val_add, l.mission_timer, "$server_mission_timer_while_player_joined"),
						(assign, reg0, l.mission_timer),
						(store_mul, "$g_multiplayer_game_max_seconds", "$g_multiplayer_game_max_minutes", 60),
						(store_sub, l.remaining_seconds, "$g_multiplayer_game_max_seconds", l.mission_timer),
						(store_div, reg0, l.remaining_seconds, 60),
						(store_mod, reg1, l.remaining_seconds, 60),
						(try_begin),
							(ge, reg0, 10),
							(ge, reg1, 10),
							(str_clear, s0),
						...
						(try_for_range, l.cur_option, 0, l.end_cond),
							(assign, reg0, -12345), #magic number
							(call_script, "script_game_get_multiplayer_server_option_for_mission_template", l.cur_mt, l.cur_option),
							(try_begin),
								(eq, reg0, -12345),
								(assign, l.end_cond, 0),
							(else_try),
								(call_script, "script_game_multiplayer_server_option_for_mission_template_to_string", l.cur_mt, l.cur_option, reg0),
	...
	("multiplayer_team_select", prsntf_manual_end_only, 0, [
			(ti_on_presentation_load,
				[(set_fixed_point_multiplier, 1000),
					...
					(multiplayer_get_my_player, l.my_player_no),
					(team_get_faction, l.faction_no, 0),
					(str_store_faction_name, s0, l.faction_no),
					(create_button_overlay, "$g_presentation_obj_team_select_1", s0, 0),
					(try_begin),
						(call_script, "script_cf_multiplayer_team_is_available", l.my_player_no, 0),
					...
					#INVASION MODE START
					(try_begin), ##ccoop
						(team_get_faction, l.faction_no, 1),
						(str_store_faction_name, s0, l.faction_no),
						(try_begin),
							(neq, "$g_multiplayer_game_type", multiplayer_game_type_captain_coop),
						...
						(try_end),
						(try_begin),
							(call_script, "script_cf_multiplayer_team_is_available", l.my_player_no, 1),
							(try_begin),
								(neq, "$g_multiplayer_game_type", multiplayer_game_type_captain_coop),
			...
			(ti_on_presentation_event_state_change,
				[(store_trigger_param_1, l.object),
					...
					(try_begin),
						...
						(try_begin),
							(eq, l.object, "$g_presentation_obj_team_select_1"),
							(try_begin),
								(call_script, "script_cf_multiplayer_team_is_available", l.my_player_no, 0),
								(try_begin),
									(player_get_team_no, l.my_team, l.my_player_no),
									(neq, l.my_team, 0),
									...
									(player_get_troop_id, "$g_confirmation_troop_backup", l.my_player_no),
									(player_get_team_no, "$g_confirmation_team_backup", l.my_player_no),
									(player_set_troop_id, l.my_player_no, -1),
									(multiplayer_send_int_to_server, multiplayer_event_change_team_no, 0),
									(player_set_team_no, l.my_player_no, 0),

									#INVASION MODE START
									(call_script, "script_mp_set_player_team_no", l.my_player_no, 0, 1),
									(try_begin),
							...
							(try_end),
						(else_try),
							(eq, l.object, "$g_presentation_obj_team_select_2"),
							(try_begin),
								(call_script, "script_cf_multiplayer_team_is_available", l.my_player_no, 1),
								(try_begin),
									(player_get_team_no, l.my_team, l.my_player_no),
									...
									(player_set_team_no, l.my_player_no, 1),
									#INVASION MODE START
									(call_script, "script_mp_set_player_team_no", l.my_player_no, 1, 1),
									(try_begin),
										(this_or_next|eq, "$g_multiplayer_game_type", multiplayer_game_type_captain_coop),
										(this_or_next|eq, "$g_multiplayer_game_type", multiplayer_game_type_deathmatch),
										(eq, "$g_multiplayer_game_type", multiplayer_game_type_duel),
							...
							(try_end),
						(else_try),
							(eq, l.object, "$g_presentation_obj_team_select_3"),
							(player_set_troop_id, l.my_player_no, -1),
							(multiplayer_send_int_to_server, multiplayer_event_change_team_no, multi_team_spectator),
							(player_set_team_no, l.my_player_no, multi_team_spectator),
							(presentation_set_duration, 0),
						(try_end),
					(try_end),
					]),
			...
			(ti_on_presentation_run,
				[
					...
					(try_begin),
						...
						(key_clicked, key_xbox_start),
						(eq, "$g_waiting_for_confirmation_to_terminate", 0),
						(multiplayer_get_my_team, l.my_team),
						(try_begin),
							(eq, l.my_team, multi_team_unassigned),
							(player_set_troop_id, l.my_player_no, -1),
							(multiplayer_send_int_to_server, multiplayer_event_change_team_no, multi_team_spectator),
							(player_set_team_no, l.my_player_no, multi_team_spectator),
						(try_end),
					...
					(else_try),
						...
						(player_set_troop_id, l.my_player_no, "$g_confirmation_troop_backup"),
						(player_set_team_no, l.my_player_no, "$g_confirmation_team_backup"),
						(assign, "$g_waiting_for_confirmation_to_terminate", 0),
						(assign, "$g_confirmation_result", 0),
						(presentation_set_duration, 0),
						(start_presentation, "prsnt_multiplayer_team_select"),
					(else_try),
						(assign, l.do_refresh, 0),
						(try_begin),
							(call_script, "script_cf_multiplayer_team_is_available", l.my_player_no, 0),
							(try_begin),
								(eq, "$g_multiplayer_team_select_1_available", 0),
								(assign, l.do_refresh, 1),
							(try_end),
						(else_try),
							#not available
							(try_begin),
	...
	("multiplayer_troop_select", prsntf_manual_end_only, 0, [
			(ti_on_presentation_load,
				[(set_fixed_point_multiplier, 1000),
					...
					(multiplayer_get_my_player, l.my_player_no),
					(player_get_team_no, l.my_team_no, l.my_player_no),
					(team_get_faction, l.my_faction_no, l.my_team_no),
					(try_for_range, l.i_multi, multi_data_troop_button_indices_begin, multi_data_troop_button_indices_end),
						(troop_set_slot, "trp_multiplayer_data", l.i_multi, -1),
					(try_end),

					(assign, l.cur_troop_index, 0),
					(try_for_range, l.troop_no, multiplayer_troops_begin, multiplayer_troops_end),
						(store_troop_faction, l.troop_faction, l.troop_no),
						(eq, l.troop_faction, l.my_faction_no),
						(str_store_troop_name, s1, l.troop_no),
						(create_button_overlay, reg0, s1, 0),
						(overlay_set_color, reg0, 0xFFFFFF),
						(store_add, l.button_index_slot, l.cur_troop_index, multi_data_troop_button_indices_begin),
						(troop_set_slot, "trp_multiplayer_data", l.button_index_slot, reg0),
						(position_set_y, pos1, l.cur_y),

						(overlay_set_position, reg0, pos1),
						(val_sub, l.cur_y, escape_menu_item_height),
						(position_set_y, pos1, l.cur_y),
						(val_add, l.cur_troop_index, 1),
					(try_end),
					(presentation_set_duration, 999999),
					]),
			...
			(ti_on_presentation_event_state_change,
				[(store_trigger_param_1, l.object),
					...
					(player_get_team_no, l.my_team_no, l.my_player_no),
					(team_get_faction, l.my_faction_no, l.my_team_no),
					(assign, l.selected_troop_no, -1),
					(assign, l.end_cond, multi_data_troop_button_indices_end),
					(try_for_range, l.i_button, multi_data_troop_button_indices_begin, l.end_cond),
						(troop_slot_eq, "trp_multiplayer_data", l.i_button, l.object),
						(store_sub, ":selected_troop_index", l.i_button, multi_data_troop_button_indices_begin),
						(assign, ":end_cond_2", multiplayer_troops_end),
						(try_for_range, l.troop_no, multiplayer_troops_begin, ":end_cond_2"),
							(store_troop_faction, l.troop_faction, l.troop_no),
							(eq, l.troop_faction, l.my_faction_no),
							(val_sub, ":selected_troop_index", 1),
							(lt, ":selected_troop_index", 0),
							(assign, l.selected_troop_no, l.troop_no),
							(assign, ":end_cond_2", 0), #break
						(try_end),
						(try_begin),
							(multiplayer_get_my_troop, l.troop_no),
							(neq, l.troop_no, l.selected_troop_no),
							(player_set_troop_id, l.my_player_no, l.selected_troop_no),
							(multiplayer_send_int_to_server, multiplayer_event_change_troop_id, l.selected_troop_no),
							(call_script, "script_multiplayer_set_default_item_selections_for_troop", l.selected_troop_no),
			...
			(ti_on_presentation_run,
				[
					(try_begin),
						...
						(key_clicked, key_xbox_start),
						(multiplayer_get_my_player, l.my_player_no),
						(is_between, l.my_player_no, 0, multiplayer_max_possible_player_id),
						(multiplayer_get_my_troop, ":my_troop"),
						(try_begin),
							#INVASION MODE START
							(eq, "$g_multiplayer_is_game_type_captain", 1),
							(neg|is_between, ":my_troop", multiplayer_troops_begin, multiplayer_troops_end),
							(call_script, "script_mp_set_player_team_no", l.my_player_no, multi_team_spectator, 1),
						(else_try),
							#INVASION MODE END
							(neg|is_between, ":my_troop", multiplayer_troops_begin, multiplayer_troops_end),
							(player_set_troop_id, l.my_player_no, -1),
	...
	("multiplayer_item_select", prsntf_manual_end_only, 0, [
			(ti_on_presentation_load,
				[(set_fixed_point_multiplier, 1000),
					...
					(player_get_slot, ":selected_item_id", l.my_player_no, ":selected_item_index"),
					(try_begin),
						(ge, ":selected_item_id", 0),
						(create_image_button_overlay, "$g_presentation_obj_item_select_1", mesh.mp_inventory_slot_empty, mesh.mp_inventory_slot_empty),
					...
					(else_try),
						(create_image_button_overlay, "$g_presentation_obj_item_select_1", mesh.mp_inventory_slot_equip, mesh.mp_inventory_slot_equip),
					(try_end),
					(position_set_x, pos1, 800),
					(position_set_y, pos1, 800),
					...
					(try_begin),
						(ge, ":selected_item_id", 0),
						(create_image_button_overlay, "$g_presentation_obj_item_select_2", mesh.mp_inventory_slot_empty, mesh.mp_inventory_slot_empty),
						(create_mesh_overlay_with_item_id, reg0, ":selected_item_id"),
						(position_set_x, pos1, 950),
					...
					(else_try),
						(create_image_button_overlay, "$g_presentation_obj_item_select_2", mesh.mp_inventory_slot_equip, mesh.mp_inventory_slot_equip),
					(try_end),
					(position_set_x, pos1, 800),
					(position_set_y, pos1, 800),
					...
					(try_begin),
						(ge, ":selected_item_id", 0),
						(create_image_button_overlay, "$g_presentation_obj_item_select_3", mesh.mp_inventory_slot_empty, mesh.mp_inventory_slot_empty),
						(create_mesh_overlay_with_item_id, reg0, ":selected_item_id"),
						(position_set_x, pos1, 950),
					...
					(else_try),
						(create_image_button_overlay, "$g_presentation_obj_item_select_3", mesh.mp_inventory_slot_equip, mesh.mp_inventory_slot_equip),
					(try_end),
					(position_set_x, pos1, 800),
					(position_set_y, pos1, 800),
					...
					(try_begin),
						(ge, ":selected_item_id", 0),
						(create_image_button_overlay, "$g_presentation_obj_item_select_4", mesh.mp_inventory_slot_empty, mesh.mp_inventory_slot_empty),
						(create_mesh_overlay_with_item_id, reg0, ":selected_item_id"),
						(position_set_x, pos1, 950),
					...
					(else_try),
						(create_image_button_overlay, "$g_presentation_obj_item_select_4", mesh.mp_inventory_slot_equip, mesh.mp_inventory_slot_equip),
					(try_end),
					(position_set_x, pos1, 800),
					(position_set_y, pos1, 800),
					...
					(try_begin),
						(ge, ":selected_item_id", 0),
						(create_image_button_overlay, "$g_presentation_obj_item_select_5", mesh.mp_inventory_slot_empty, mesh.mp_inventory_slot_empty),
						(create_mesh_overlay_with_item_id, reg0, ":selected_item_id"),
					...
					(else_try),
						(create_image_button_overlay, "$g_presentation_obj_item_select_5", mesh.mp_inventory_slot_helmet, mesh.mp_inventory_slot_helmet),
					(try_end),
					(position_set_x, pos1, 800),
					(position_set_y, pos1, 800),
					...
					(try_begin),
						(ge, ":selected_item_id", 0),
						(create_image_button_overlay, "$g_presentation_obj_item_select_6", mesh.mp_inventory_slot_empty, mesh.mp_inventory_slot_empty),
						(create_mesh_overlay_with_item_id, reg0, ":selected_item_id"),
						(position_set_x, pos1, 53),
					...
					(else_try),
						(create_image_button_overlay, "$g_presentation_obj_item_select_6", mesh.mp_inventory_slot_armor, mesh.mp_inventory_slot_armor),
					(try_end),
					(position_set_x, pos1, 800),
					(position_set_y, pos1, 800),
					...
					(try_begin),
						(ge, ":selected_item_id", 0),
						(create_image_button_overlay, "$g_presentation_obj_item_select_7", mesh.mp_inventory_slot_empty, mesh.mp_inventory_slot_empty),
						(create_mesh_overlay_with_item_id, reg0, ":selected_item_id"),
						(position_set_x, pos1, 53),
					...
					(else_try),
						(create_image_button_overlay, "$g_presentation_obj_item_select_7", mesh.mp_inventory_slot_boot, mesh.mp_inventory_slot_boot),
					(try_end),
					(position_set_x, pos1, 800),
					(position_set_y, pos1, 800),
					...
					(try_begin),
						(ge, ":selected_item_id", 0),
						(create_image_button_overlay, "$g_presentation_obj_item_select_8", mesh.mp_inventory_slot_empty, mesh.mp_inventory_slot_empty),
						(create_mesh_overlay_with_item_id, reg0, ":selected_item_id"),
						(position_set_x, pos1, 53),
					...
					(else_try),
						(create_image_button_overlay, "$g_presentation_obj_item_select_8", mesh.mp_inventory_slot_glove, mesh.mp_inventory_slot_glove),
					(try_end),
					(position_set_x, pos1, 800),
					(position_set_y, pos1, 800),
					...
					(try_begin),
						...
						(create_image_button_overlay, "$g_presentation_obj_item_select_9", mesh.mp_inventory_slot_empty, mesh.mp_inventory_slot_empty),
						(create_mesh_overlay_with_item_id, reg0, ":selected_item_id"),
						(position_set_x, pos1, 53),
					...
					(else_try),
						(create_image_button_overlay, "$g_presentation_obj_item_select_9", mesh.mp_inventory_slot_horse, mesh.mp_inventory_slot_horse),
					(try_end),
					(position_set_x, pos1, 800),
					(position_set_y, pos1, 800),
					...
					(try_begin),
						...
						(try_begin),
							...
							(try_for_range, ":ai_troop_no", multiplayer_ai_troops_begin, multiplayer_ai_troops_end),
								...
								(eq, ":ai_troop_faction", l.my_faction_no),
								(val_add, ":num_lines", 1),
							(try_end),
						(try_end),
						...
						(try_begin),
							...
							(try_for_range, ":ai_troop_no", multiplayer_ai_troops_begin, multiplayer_ai_troops_end),
								...
								(store_add, l.special_cur_y, l.cur_y, 2),
								(position_set_y, pos1, l.special_cur_y),
								(overlay_set_position, reg0, pos1),
								(try_begin),
					...
					(multiplayer_get_my_player, l.my_player_no),
					(player_get_gold, ":player_gold", l.my_player_no),
					(call_script, "script_multiplayer_calculate_cur_selected_items_cost", l.my_player_no, 1),
					...
					(player_get_troop_id, ":my_troop_no", l.my_player_no),
					(try_begin),
					...
					(else_try),
						...
						(call_script, "script_mp_set_coop_companions", l.my_player_no),
						#(call_script, "script_multiplayer_create_available_troops_buttons", l.my_player_no, l.my_faction_no),
						...
						(multiplayer_get_my_player, l.my_player_no),
						(player_get_slot, ":spawn_status", l.my_player_no, slot_player_companion_ids_locked),
						...
						(player_get_slot, ":my_companion_0_level", l.my_player_no, slot_player_companion_levels_begin),
						...
						(player_get_slot, ":my_companion_1_level", l.my_player_no, slot_player_companion_levels_begin + 1),
						...
						(create_image_button_overlay, "$g_presentation_obj_coop_companion_random_select_0", mesh.ccoop_random_class, mesh.ccoop_random_class),
						...
						(create_image_button_overlay, "$g_presentation_obj_coop_companion_random_select_1", mesh.ccoop_random_class, mesh.ccoop_random_class),
						(position_set_x, pos1, 60),
						(position_set_y, pos1, 80),
						...
						(create_image_button_overlay, "$g_presentation_obj_coop_companion_class_select_0_default", mesh.ccoop_default_class, mesh.ccoop_default_class),
						(create_image_button_overlay, "$g_presentation_obj_coop_companion_class_select_1_default", mesh.ccoop_default_class, mesh.ccoop_default_class),
						(create_image_button_overlay, "$g_presentation_obj_coop_companion_class_select_0_infantry", mesh.ccoop_melee_class, mesh.ccoop_melee_class),
						(create_image_button_overlay, "$g_presentation_obj_coop_companion_class_select_1_infantry", mesh.ccoop_melee_class, mesh.ccoop_melee_class),
						(create_image_button_overlay, "$g_presentation_obj_coop_companion_class_select_0_ranged", mesh.ccoop_ranged_class, mesh.ccoop_ranged_class),
						(create_image_button_overlay, "$g_presentation_obj_coop_companion_class_select_1_ranged", mesh.ccoop_ranged_class, mesh.ccoop_ranged_class),
						(create_image_button_overlay, "$g_presentation_obj_coop_companion_class_select_0_mounted", mesh.ccoop_mounted_class, mesh.ccoop_mounted_class),
						(create_image_button_overlay, "$g_presentation_obj_coop_companion_class_select_1_mounted", mesh.ccoop_mounted_class, mesh.ccoop_mounted_class),
						...
						#(multiplayer_get_my_player, l.my_player_no),
						#(player_get_troop_id, ":my_troop_no", l.my_player_no),
						(team_get_faction, l.my_faction_no, 0),
						...
						(try_for_range, ":cur_template", multiplayer_coop_class_templates_begin, multiplayer_coop_class_templates_end),
							...
							(eq, ":trp_faction", l.my_faction_no),
				...
				[(store_trigger_param_1, l.object),
					...
					(else_try),
						...
						(try_begin),
							...
							(assign, ":item_no", -1),
							(try_begin),
								(ge, l.object, "$g_presentation_obj_item_select_next"),
								(store_sub, ":tested_object", l.object, "$g_presentation_obj_item_select_next"),
								...
								(assign, ":target_obj", l.object),
								(val_add, ":target_obj", ":mod_value"),
							(else_try),
								(eq, l.object, "$g_presentation_obj_item_select_1"),
								(store_add, ":player_slot_index", slot_player_selected_item_indices_begin, 1),
								(val_sub, ":player_slot_index", 1),
								(multiplayer_get_my_player, l.my_player_no),
								(player_get_slot, ":item_no", l.my_player_no, ":player_slot_index"),
								(assign, ":target_obj", "$g_inside_obj_1"),
							(else_try),
								(eq, l.object, "$g_presentation_obj_item_select_2"),
							...
							(else_try),
								(eq, l.object, "$g_presentation_obj_item_select_3"),
							...
							(else_try),
								(eq, l.object, "$g_presentation_obj_item_select_4"),
							...
							(else_try),
								(eq, l.object, "$g_presentation_obj_item_select_5"),
							...
							(else_try),
								(eq, l.object, "$g_presentation_obj_item_select_6"),
							...
							(else_try),
								(eq, l.object, "$g_presentation_obj_item_select_7"),
							...
							(else_try),
								(eq, l.object, "$g_presentation_obj_item_select_8"),
							...
							(else_try),
								(eq, l.object, "$g_presentation_obj_item_select_9"),
								(eq, "$g_horses_are_avaliable", 1),
							...
							(try_begin),
								...
								(multiplayer_get_my_player, l.my_player_no),
								(player_get_troop_id, ":my_player_troop_no", l.my_player_no),
								(try_begin),
			...
			(ti_on_presentation_event_state_change,
				[(store_trigger_param_1, l.object),
					...
					(player_get_troop_id, ":my_troop_no", l.my_player_no),
					#INVASION MODE START
					(player_get_team_no, ":my_player_team", l.my_player_no),
					#INVASION MODE END
					...
					(try_begin),
						...
						(try_begin),
							...
							(else_try),
								...
								#INVASION MODE START
							(else_try),#Berk
								(eq, l.object, "$g_presentation_obj_item_select_17"),
								(assign, "$g_presentation_state", 10),
								(presentation_set_duration, 0),
								(start_presentation, "prsnt_multiplayer_item_select"),
								#INVASION MODE END
						...
						(else_try),
							...
							(store_sub, ":tested_object", l.object, "$g_presentation_obj_item_select_next"),
							(val_div, ":tested_object", 2),
							(assign, l.end_cond, multi_data_item_button_indices_end),
							(try_for_range, ":cur_slot", multi_data_item_button_indices_begin, l.end_cond),
								...
								(try_begin),
									...
									(val_sub, ":player_slot_index", 1),
									(player_set_slot, l.my_player_no, ":player_slot_index", ":item_no"),
						...
						(else_try),
							...
							(try_begin),
								(eq, l.object, "$g_presentation_obj_coop_companion_select_done"),
							...
							(else_try),
								...
								(player_get_troop_id, ":my_troop_no", l.my_player_no),
								(team_get_faction, l.my_faction_no, 0),
								(player_slot_eq, l.my_player_no, slot_player_companion_ids_locked, 0),
								(this_or_next|eq, l.object, "$g_presentation_obj_coop_companion_random_select_0"),
								(eq, l.object, "$g_presentation_obj_coop_companion_select_0"),
								(try_begin),
									(eq, l.object, "$g_presentation_obj_coop_companion_random_select_0"),
									(store_random_in_range, l.value, multiplayer_coop_companion_equipment_sets_begin, multiplayer_coop_companion_first_equipment_sets_end),
								(else_try),
									(val_add, l.value, multiplayer_coop_companion_equipment_sets_begin),
								(try_end),
								(store_sub, ":add_sub_test", l.value, "$g_presentation_obj_coop_companion_0"),
								(try_begin),
									(eq, l.value, "$g_presentation_obj_coop_companion_1"),
									(try_begin),
										(neq, ":add_sub_test", 15),
										...
										(val_add, l.value, 1),
										(try_begin),
											(ge, l.value, multiplayer_coop_companion_first_equipment_sets_end),
											(assign, l.value, multiplayer_coop_companion_equipment_sets_begin),
										(try_end),
									(else_try),
										(val_sub, l.value, 1),
										(try_begin),
											(lt, l.value, multiplayer_coop_companion_equipment_sets_begin),
											(assign, l.value, multiplayer_coop_companion_first_equipment_sets_end),
											(val_sub, l.value, 1),
										(try_end),
									(try_end),
								(try_end),
								(assign, "$g_presentation_obj_coop_companion_0", l.value),
								(try_begin),
									...
									(store_sub, l.value, "$g_presentation_obj_coop_companion_0", multiplayer_coop_companion_equipment_sets_begin),
									(val_add, l.value, multiplayer_coop_companion_equipment_sets_begin),
									#(val_add, l.value, 1),
									(assign, "$g_presentation_obj_coop_companion_class_0", l.value),
								(try_end),
								(call_script, "script_mp_set_coop_companions", l.my_player_no),
								#(assign, reg0, "$g_presentation_obj_coop_companion_0"),
							...
							(else_try),
								(player_slot_eq, l.my_player_no, slot_player_companion_ids_locked, 0),
								(this_or_next|eq, l.object, "$g_presentation_obj_coop_companion_random_select_1"),
								(eq, l.object, "$g_presentation_obj_coop_companion_select_1"),
								(try_begin),
									(eq, l.object, "$g_presentation_obj_coop_companion_random_select_1"),
									(store_random_in_range, l.value, multiplayer_coop_companion_equipment_sets_begin, multiplayer_coop_companion_first_equipment_sets_end),
								(else_try),
									(val_add, l.value, multiplayer_coop_companion_equipment_sets_begin),
								(try_end),
								(store_sub, ":add_sub_test", l.value, "$g_presentation_obj_coop_companion_1"),
								(try_begin),
									(eq, l.value, "$g_presentation_obj_coop_companion_0"),
									(try_begin),
										(neq, ":add_sub_test", 15),
										(this_or_next|gt, ":add_sub_test", 0),
										(eq, ":add_sub_test", -15), #back to start of list (should be calculated in code)
									...
									(try_end),
								(try_end),
								(assign, "$g_presentation_obj_coop_companion_1", l.value),
								(try_begin),
									...
									(store_sub, l.value, "$g_presentation_obj_coop_companion_1", multiplayer_coop_companion_equipment_sets_begin),
									(val_add, l.value, multiplayer_coop_companion_equipment_sets_begin),
									#(val_add, l.value, 1),
									(assign, "$g_presentation_obj_coop_companion_class_1", l.value),
								(try_end),
								(call_script, "script_mp_set_coop_companions", l.my_player_no),
								(presentation_set_duration, 0),
								(start_presentation, "prsnt_multiplayer_item_select"),
							(else_try),
								(eq, l.object, "$g_presentation_obj_coop_companion_class_select_0_default"),
								(assign, "$g_presentation_obj_coop_companion_class_0", "$g_presentation_obj_coop_companion_0"),
								(call_script, "script_mp_set_coop_companions", l.my_player_no),
								(presentation_set_duration, 0),
								(start_presentation, "prsnt_multiplayer_item_select"),
							(else_try),
								(eq, l.object, "$g_presentation_obj_coop_companion_class_select_1_default"),
							...
							(else_try),
								(this_or_next|eq, l.object, "$g_presentation_obj_coop_companion_random_select_0"),
								(this_or_next|eq, l.object, "$g_presentation_obj_coop_companion_class_select_0_infantry"),
								(this_or_next|eq, l.object, "$g_presentation_obj_coop_companion_class_select_0_ranged"),
								(this_or_next|eq, l.object, "$g_presentation_obj_coop_companion_class_select_0_mounted"),
								(this_or_next|eq, l.object, "$g_presentation_obj_coop_companion_random_select_1"),
								(this_or_next|eq, l.object, "$g_presentation_obj_coop_companion_class_select_1_infantry"),
								(this_or_next|eq, l.object, "$g_presentation_obj_coop_companion_class_select_1_ranged"),
								(eq, l.object, "$g_presentation_obj_coop_companion_class_select_1_mounted"),
							(else_try),
								(presentation_set_duration, 0),
								(assign, "$g_presentation_state", 0),
								(start_presentation, "prsnt_multiplayer_item_select"),
							...
							(try_begin),
								...
								(this_or_next|eq, l.object, "$g_presentation_obj_coop_companion_class_select_0_infantry"),
								(this_or_next|eq, l.object, "$g_presentation_obj_coop_companion_class_select_0_ranged"),
								(eq, l.object, "$g_presentation_obj_coop_companion_class_select_0_mounted"),
								(try_begin),
									(eq, l.object, "$g_presentation_obj_coop_companion_random_select_0"),
									...
									(else_try),
										...
										(else_try),
											(eq, ":random_class", 1),
											(assign, l.object, "$g_presentation_obj_coop_companion_class_select_0_infantry"),
										(else_try),
											(eq, ":random_class", 2),
											(assign, l.object, "$g_presentation_obj_coop_companion_class_select_0_ranged"),
										(else_try),
											(eq, ":random_class", 3),
											(assign, l.object, "$g_presentation_obj_coop_companion_class_select_0_mounted"),
										(try_end),
									(try_end),
									(eq, ":random_class", 0),
								(else_try),
									...
									(try_for_range, ":cur_template", multiplayer_coop_class_templates_begin, multiplayer_coop_class_templates_end),
										...
										(try_begin),
											...
											(eq, l.object, "$g_presentation_obj_coop_companion_class_select_0_infantry"),
											#(display_message, "@setting companion 0 as infantry"),
											(assign, "$g_presentation_obj_coop_companion_class_0", ":cur_template"),
										(else_try),
											(eq, ":eligible_troop_count", 1),
											#(display_message, "@setting selection class {reg0}: {s0}"),
											(eq, l.object, "$g_presentation_obj_coop_companion_class_select_0_ranged"),
							...
							(else_try),
								...
								(try_begin),
									...
									(else_try),
										...
										(else_try),
											(eq, ":random_class", 1),
											(assign, l.object, "$g_presentation_obj_coop_companion_class_select_1_infantry"),
										(else_try),
											(eq, ":random_class", 2),
											(assign, l.object, "$g_presentation_obj_coop_companion_class_select_1_ranged"),
										(else_try),
											(eq, ":random_class", 3),
											(assign, l.object, "$g_presentation_obj_coop_companion_class_select_1_mounted"),
										(try_end),
									(try_end),
									(eq, ":random_class", 0),
								(else_try),
									...
									(try_for_range, ":cur_template", multiplayer_coop_class_templates_begin, multiplayer_coop_class_templates_end),
										...
										(try_begin),
											(eq, ":eligible_troop_count", 2),
											(eq, l.object, "$g_presentation_obj_coop_companion_class_select_1_infantry"),
											(assign, "$g_presentation_obj_coop_companion_class_1", ":cur_template"),
										(else_try),
											(eq, ":eligible_troop_count", 1),
											(eq, l.object, "$g_presentation_obj_coop_companion_class_select_1_ranged"),
											(assign, "$g_presentation_obj_coop_companion_class_1", ":cur_template"),
										(else_try),
											(eq, ":eligible_troop_count", 3),
											(eq, l.object, "$g_presentation_obj_coop_companion_class_select_1_mounted"),
						...
						(try_end),
						(try_begin),
							(eq, l.object, "$g_presentation_obj_item_select_10"),
							(call_script, "script_multiplayer_set_default_item_selections_for_troop", ":my_troop_no"),
							(presentation_set_duration, 0),
							(assign, "$g_presentation_state", 0),
							(start_presentation, "prsnt_multiplayer_item_select"),
						(else_try),
							(eq, l.object, "$g_presentation_obj_item_select_11"),
							(call_script, "script_multiplayer_send_item_selections"),
							(presentation_set_duration, 0),
							...
							(try_end),
						(else_try),
							(eq, l.object, "$g_presentation_obj_item_select_13"),
							(assign, "$g_multiplayer_bot_type_1_wanted", l.value),
							(multiplayer_send_2_int_to_server, multiplayer_event_set_bot_selection, slot_player_bot_type_1_wanted, l.value),
						(else_try),
							(eq, l.object, "$g_presentation_obj_item_select_14"),
							(assign, "$g_multiplayer_bot_type_2_wanted", l.value),
							(multiplayer_send_2_int_to_server, multiplayer_event_set_bot_selection, slot_player_bot_type_2_wanted, l.value),
						(else_try),
							(eq, l.object, "$g_presentation_obj_item_select_15"),
							(assign, "$g_multiplayer_bot_type_3_wanted", l.value),
							(multiplayer_send_2_int_to_server, multiplayer_event_set_bot_selection, slot_player_bot_type_3_wanted, l.value),
						(else_try),
							(eq, l.object, "$g_presentation_obj_item_select_16"),
							(assign, "$g_multiplayer_bot_type_4_wanted", l.value),
							(multiplayer_send_2_int_to_server, multiplayer_event_set_bot_selection, slot_player_bot_type_4_wanted, l.value),
						(try_end),
					(else_try),
						(assign, "$g_close_equipment_selection", 0),
						#INVASION MODE START
						...
						(try_begin),
							...
							(try_begin),
								...
								(try_begin),
									(eq, l.object, "$g_presentation_obj_item_select_1"),
									(store_add, ":selected_item_index", slot_player_selected_item_indices_begin, 0),
									(player_set_slot, l.my_player_no, ":selected_item_index", -1),
									(presentation_set_duration, 0),
									(assign, "$g_presentation_state", 0),
									(start_presentation, "prsnt_multiplayer_item_select"),
								(else_try),
	...
	("multiplayer_message_1", prsntf_read_only|prsntf_manual_end_only, 0, [
			(ti_on_presentation_load, [
					...
					(else_try),
						...
						(try_begin),
							(ge, l.my_player_no, 0),
							(player_get_agent_id, ":my_player_agent", l.my_player_no),
							(try_begin),
					...
					(else_try),
						...
						(try_begin),
							...
							(try_begin),
								(multiplayer_get_my_player, l.my_player_no),
								(player_get_team_no, l.my_team_no, l.my_player_no),
								(neq, ":scene_prop_team", l.my_team_no), #if scene prop and I have different teams this means we won
								(assign, ":text_font_color", 0xFF33DD11),
							(else_try),
								(assign, ":text_font_color", 0xFFFF4422),
							(try_end),
	...
	("multiplayer_flag_projection_display", prsntf_read_only|prsntf_manual_end_only, 0, [
			(ti_on_presentation_load,
				[
					...
					(else_try),
						(assign, ":flag_mesh", mesh.flag_project_rb),
						(create_mesh_overlay, "$g_presentation_obj_flag_projection_display_3", ":flag_mesh"),
						(assign, ":flag_mesh", mesh.flag_project_rb_miss),
						(create_mesh_overlay, "$g_presentation_obj_flag_projection_display_4", ":flag_mesh"),
					(try_end),
			...
			(ti_on_presentation_run,
				[
					...
					(position_get_x, l.x_pos, pos3),
					(position_get_y, l.y_pos, pos3),
					(position_set_y, pos3, l.y_pos),
					(try_begin),
						(is_between, l.x_pos, -100, 1100),
						(is_between, l.y_pos, -100, 850),
	...
	("multiplayer_respawn_time_counter", prsntf_read_only|prsntf_manual_end_only, 0, [
			...
			(ti_on_presentation_run, [
					...
					(try_begin),
						(ge, l.my_player_no, 0),
						(player_get_team_no, ":player_team", l.my_player_no),
						(try_begin),
			...
			(ti_on_presentation_load,
				[(set_fixed_point_multiplier, 1000),
					...
					(try_for_range, ":i_team", 0, multi_team_spectator),
						...
						(assign, l.cur_y, ":y_needed"),
						(team_get_faction, l.cur_faction, ":i_team"),
						(str_store_faction_name, s1, l.cur_faction),
						...
						(store_sub, ":cur_y_sub_10", l.cur_y, 10),
						...
						(try_begin),
							...
							(create_mesh_overlay, reg0, mesh.ui_kingdom_shield_7),
						(else_try),
							(eq, l.cur_faction, "fac_kingdom_4"),
							(create_mesh_overlay, reg0, mesh.ui_kingdom_shield_1),
						(else_try),
							(eq, l.cur_faction, "fac_kingdom_2"),
							(create_mesh_overlay, reg0, mesh.ui_kingdom_shield_2),
						(else_try),
							(eq, l.cur_faction, "fac_kingdom_3"),
							(create_mesh_overlay, reg0, mesh.ui_kingdom_shield_3),
						(else_try),
							(eq, l.cur_faction, "fac_kingdom_5"),
							(create_mesh_overlay, reg0, mesh.ui_kingdom_shield_4),
						(else_try),
							(eq, l.cur_faction, "fac_kingdom_6"),
							(create_mesh_overlay, reg0, mesh.ui_kingdom_shield_5),
						(else_try),
							(eq, l.cur_faction, "fac_kingdom_1"),
							(create_mesh_overlay, reg0, mesh.ui_kingdom_shield_6),
						(try_end),
						...
						(try_begin), #counting number of flags each team has only at hq mod.
							...
							(store_add, ":sub_cur_y", l.cur_y, -10),
							(position_set_x, pos1, ":sub_cur_x"),
							(position_set_y, pos1, ":sub_cur_y"),
							(overlay_set_position, reg0, pos1),
						...
						(store_add, l.end_cond, ":num_players", 1),
						(try_for_range, l.unused, 0, l.end_cond),
							...
							(try_begin),
								...
								(try_begin),
									(eq, l.my_player_no, ":max_score_plus_death_player_no"),
									(create_mesh_overlay, reg0, mesh.white_plane),
									(overlay_set_color, reg0, 0xFFFFFF),
							...
							(else_try),
								(try_begin),
									...
									(val_sub, l.cur_y, 20),
								(try_end),
								(assign, l.end_cond, 0), #all players are written for this team, break
							(try_end),
						(try_end),

						(try_begin),
							(eq, ":i_team", 0),
							(assign, ":old_cur_y", l.cur_y),
						(try_end),
					(try_end),

					(try_begin),
						(le, ":old_cur_y", l.cur_y),
						(assign, l.cur_y, ":old_cur_y"),
					(try_end),
					...
					(try_begin),
						...
						(store_add, l.end_cond, ":num_players", 1),
						(try_for_range, ":player_no", 0, l.end_cond),
							(store_add, ":slot_index", ":player_no", multi_data_player_index_list_begin),
							(troop_slot_eq, "trp_multiplayer_data", ":slot_index", 1),
				...
				[(set_fixed_point_multiplier, 1000),
					...
					(try_for_range, l.unused, 0, l.end_cond),
						...
						(try_begin),
							...
							(try_begin),
								(eq, l.my_player_no, ":max_kills_player_no"),
								(create_mesh_overlay, reg0, mesh.white_plane),
								(overlay_set_color, reg0, 0xFFFFFF),
								(overlay_set_alpha, reg0, 0x35),
								(store_add, ":sub_cur_x", ":cur_x", 0),
						...
						(else_try),
							...
							(assign, l.end_cond, 0), #all players are written, break
						(else_try),
							(assign, l.end_cond, 0), #all players are written, break
						(try_end),
					(try_end),
	...
	("multiplayer_escape_menu", prsntf_manual_end_only, 0, [
			(ti_on_presentation_load,
				[
					...
					(try_begin),
						(lt, l.my_team, multi_team_spectator),
					...
					(try_begin),
						...
						(try_begin),
							(ge, l.my_player_no, 0),
							(player_get_slot, ":last_poll_time", l.my_player_no, slot_player_poll_disabled_until_time),
							(store_mission_timer_a, l.mission_timer),
							(lt, l.mission_timer, ":last_poll_time"),
					...
					(try_begin),
						(ge, l.my_player_no, 0),
						(player_is_admin, l.my_player_no),
			...
			(ti_on_presentation_event_state_change,
				[
					(store_trigger_param_1, l.object),
					(try_begin),
						(eq, l.object, "$g_presentation_obj_escape_menu_1"),
						(presentation_set_duration, 0),
						(start_presentation, "prsnt_multiplayer_team_select"),
					(else_try),
						(eq, l.object, "$g_presentation_obj_escape_menu_2"),
						(presentation_set_duration, 0),
						(start_presentation, "prsnt_multiplayer_troop_select"),
					(else_try),
						(eq, l.object, "$g_presentation_obj_escape_menu_3"),
						(presentation_set_duration, 0),
						(assign, "$g_presentation_state", 0),
						(start_presentation, "prsnt_multiplayer_item_select"),
					(else_try),
						(eq, l.object, "$g_presentation_obj_escape_menu_4"),
						(presentation_set_duration, 0),
						(change_screen_options),
					(else_try),
						(eq, l.object, "$g_presentation_obj_escape_menu_5"),
						(presentation_set_duration, 0),
						(change_screen_controls),
					(else_try),
						(eq, l.object, "$g_presentation_obj_escape_menu_6"),
						(eq, "$g_presentation_obj_escape_menu_6_available", 1),
						(presentation_set_duration, 0),
						(start_presentation, "prsnt_multiplayer_poll_menu"),
					(else_try),
						(eq, l.object, "$g_presentation_obj_escape_menu_7"),
						(presentation_set_duration, 0),
						(multiplayer_send_message_to_server, multiplayer_event_open_admin_panel),
					(else_try),
						(eq, l.object, "$g_presentation_obj_escape_menu_8"),
						(presentation_set_duration, 0),
						(assign, "$g_multiplayer_players_list_action_type", 3), #admin kick
						(start_presentation, "prsnt_multiplayer_show_players_list"),
					(else_try),
						(eq, l.object, "$g_presentation_obj_escape_menu_9"),
						(presentation_set_duration, 0),
						(assign, "$g_multiplayer_players_list_action_type", 4), #admin ban
						(start_presentation, "prsnt_multiplayer_show_players_list"),
					(else_try),
						(eq, l.object, "$g_presentation_obj_escape_menu_10"),
						(presentation_set_duration, 0),
						(finish_mission, 0),
					(else_try),
						(eq, l.object, "$g_presentation_obj_escape_menu_11"),
						(presentation_set_duration, 0),
						(assign, "$g_multiplayer_players_list_action_type", 5), #mute player
						(start_presentation, "prsnt_multiplayer_show_players_list"),
					(else_try),
						(eq, l.object, "$g_presentation_obj_escape_menu_12"),
						(presentation_set_duration, 0),
						(assign, "$g_multiplayer_players_list_action_type", 6), #unmute player
						(start_presentation, "prsnt_multiplayer_show_players_list"),
					(else_try),
						(eq, l.object, "$g_presentation_obj_escape_menu_13"),
						(presentation_set_duration, 0),
	...
	("multiplayer_show_players_list", prsntf_manual_end_only, 0, [
			(ti_on_presentation_load,
				[(set_fixed_point_multiplier, 1000),
					...
					(try_for_range, ":player_no", 1, ":num_players"), #0 is server no need to write it
						...
						(val_add, l.cur_y, escape_menu_item_height),
					(try_end),
			...
			(ti_on_presentation_event_state_change,
				[(store_trigger_param_1, l.object),
					...
					(try_for_range, ":player_no", 1, ":num_players"), #0 is server no need to write it
						(player_is_active, ":player_no"),
						(player_slot_eq, ":player_no", slot_player_button_index, l.object),
						(try_begin),
							...
							(try_begin),
								...
								(store_mission_timer_a, l.mission_timer),
								(val_add, l.mission_timer, multiplayer_poll_disable_period),
								(player_set_slot, l.my_player_no, slot_player_poll_disabled_until_time, l.mission_timer),
							(try_end),
						(else_try),
	...
	("multiplayer_show_maps_list", prsntf_manual_end_only, 0, [
			(ti_on_presentation_load,
				[(set_fixed_point_multiplier, 1000),
					...
					(call_script, "script_multiplayer_fill_map_game_types", "$g_multiplayer_game_type"),
					(assign, l.num_maps, reg0),
					(store_mul, l.cur_y, l.num_maps, escape_menu_item_height),
					(val_add, l.cur_y, 10),
					...
					(store_sub, "$g_show_maps_list_button_list_first_index", "$g_show_maps_list_button_list_end_index", l.num_maps),

					(presentation_set_duration, 999999),
					]),
			(ti_on_presentation_event_state_change,
				[(store_trigger_param_1, l.object),
					(try_for_range, l.i_button, "$g_show_maps_list_button_list_first_index", "$g_show_maps_list_button_list_end_index"),
						(eq, l.object, l.i_button),
						(call_script, "script_multiplayer_fill_map_game_types", "$g_multiplayer_game_type"),
						(store_sub, l.map_slot, l.object, "$g_show_maps_list_button_list_first_index"),
						(val_add, l.map_slot, multi_data_maps_for_game_type_begin),
						(troop_get_slot, ":scene_id", "trp_multiplayer_data", l.map_slot),
						(presentation_set_duration, 0),
						(try_begin),
			...
			(ti_on_presentation_load,
				[(set_fixed_point_multiplier, 1000),
					...
					(try_begin),
						...
						(val_sub, l.num_factions, 1),
					(try_end),
					(store_mul, l.cur_y, l.num_factions, escape_menu_item_height),
					(val_add, l.cur_y, 10),
					...
					(store_sub, "$g_show_factions_list_button_list_first_index", "$g_show_factions_list_button_list_end_index", l.num_factions),

					(presentation_set_duration, 999999),
					]),
			(ti_on_presentation_event_state_change,
				[(store_trigger_param_1, l.object),
					(try_for_range, l.i_button, "$g_show_factions_list_button_list_first_index", "$g_show_factions_list_button_list_end_index"),
						(eq, l.object, l.i_button),
						(store_sub, l.faction_no, l.object, "$g_show_factions_list_button_list_first_index"),
						(val_add, l.faction_no, npc_kingdoms_begin),
						(presentation_set_duration, 0),
						(try_begin),
							(eq, "$g_multiplayer_factions_list_action_type", 2), #vote for second team
							(try_begin),
								(ge, l.faction_no, "$g_multiplayer_poll_for_map_and_faction_data_faction_1"),
								(val_add, l.faction_no, 1),
							(try_end),
							(try_begin),
								(multiplayer_get_my_player, l.my_player_no),
								(ge, l.my_player_no, 0),
								(multiplayer_send_4_int_to_server, multiplayer_event_start_new_poll, 3, "$g_multiplayer_poll_for_map_and_faction_data_map", "$g_multiplayer_poll_for_map_and_faction_data_faction_1", l.faction_no),
								(store_mission_timer_a, l.mission_timer),
								(val_add, l.mission_timer, multiplayer_poll_disable_period),
								(player_set_slot, l.my_player_no, slot_player_poll_disabled_until_time, l.mission_timer),
							(try_end),
						(else_try), #vote for first team
							...
							(assign, "$g_multiplayer_poll_for_map_and_faction_data_faction_1", l.faction_no),
							(start_presentation, "prsnt_multiplayer_show_factions_list"),
						(try_end),
	...
	("multiplayer_show_number_of_bots_list", prsntf_manual_end_only, 0, [
			(ti_on_presentation_load,
				[(set_fixed_point_multiplier, 1000),
					...
					(store_add, l.end_cond, "$g_multiplayer_num_bots_voteable", 1),
					(try_for_range, ":i_number", 0, l.end_cond),
					...
					(store_mul, l.cur_y, ":num_options", escape_menu_item_height),
					(val_add, l.cur_y, 10),
			...
			(ti_on_presentation_event_state_change,
				[(store_trigger_param_1, l.object),
					(try_for_range, l.i_button, "$g_show_number_of_bots_list_button_list_first_index", "$g_show_number_of_bots_list_button_list_end_index"),
						(eq, l.object, l.i_button),
						(store_sub, ":value_index", l.object, "$g_show_number_of_bots_list_button_list_first_index"),
						(try_begin),
							(lt, ":value_index", 10),
	...
	("multiplayer_poll", prsntf_read_only|prsntf_manual_end_only, 0, [
			(ti_on_presentation_load,
				[(set_fixed_point_multiplier, 1000),
					...
					(try_begin),
						...
						(store_sub, l.string_index, "$g_multiplayer_poll_value_to_show", multiplayer_scenes_begin),
						(val_add, l.string_index, multiplayer_scene_names_begin),
						(str_store_string, s0, l.string_index),
					...
					(store_mission_timer_a, l.mission_timer),
					(store_sub, "$g_multiplayer_poll_last_written_seconds_left", "$g_multiplayer_poll_client_end_time", l.mission_timer),
			...
			(ti_on_presentation_run,
				[(store_trigger_param_1, ":cur_time"),
					...
					(try_end),
					(store_mission_timer_a, l.mission_timer),
					(store_sub, ":time_left", "$g_multiplayer_poll_client_end_time", l.mission_timer),
					(try_begin),
			...
			(ti_on_presentation_load,
				[
					...
					(else_try),
						...
						(store_add, ":arrow_mesh", "$g_tutorial_mouse_dir", mesh.mouse_arrow_down),
	...
	("name_kingdom",0,mesh.load_window,[
			...
			(ti_on_presentation_event_state_change,
				[(store_trigger_param_1, l.object),
					(try_begin),
						(eq, l.object, "$g_presentation_obj_name_kingdom_1"),
						(str_store_string, s7, s0),
					(else_try),
						(eq, l.object, "$g_presentation_obj_name_kingdom_2"),
	...
	("banner_selection",0,mesh.load_window,[
			(ti_on_presentation_load,
				[(set_fixed_point_multiplier, 1000),
					...
					(assign, l.x_pos, 150),
					(assign, l.y_pos, 575),
					(assign, ":try__end", banner_meshes_end_minus_one),
					(store_sub, ":num_npc_kingdoms", npc_kingdoms_end, npc_kingdoms_begin),
					(val_sub, ":try__end", ":num_npc_kingdoms"), #do not allow kingdom banners to be selected
					(store_mul, ":begin_mesh", 16, g.g_presentation_page_no),
					(val_add, ":begin_mesh", banner_meshes_begin),
					(store_add, ":try__end2", ":begin_mesh", 16),
					(val_min, ":try__end", ":try__end2"),
					(store_add, g.g_presentation_banner_start, "$g_presentation_obj_banner_selection_1", 1),
					(try_for_range, l.cur_banner_mesh, ":begin_mesh", ":try__end"),
						(create_image_button_overlay, reg1, l.cur_banner_mesh, l.cur_banner_mesh),
						(position_set_x, pos1, l.x_pos),
						(position_set_y, pos1, l.y_pos),
						(overlay_set_position, reg1, pos1),
			...
			(ti_on_presentation_event_state_change,
				[(store_trigger_param_1, l.object),
					(try_begin),
						(eq, l.object, "$g_presentation_obj_banner_selection_1"),
						(val_add, g.g_presentation_page_no, 1),
						(val_mod, g.g_presentation_page_no, 8),
					...
					(else_try),
						...
						(store_mul, l.page_adder, 16, g.g_presentation_page_no),
						(val_add, l.selected_banner, l.page_adder),
						(store_add, ":selected_banner_map_icon", l.selected_banner, banner_map_icons_begin),
						(party_set_banner_icon, "p_main_party", ":selected_banner_map_icon"),
						(store_add, ":selected_banner_spr", l.selected_banner, banner_scene_props_begin),
						...
						#(assign, l.end_cond, active_npcs_end),
						#(try_for_range, l.cur_troop, original_kingdom_heroes_begin, l.end_cond),
						#  (troop_slot_eq, l.cur_troop, slot_troop_banner_scene_prop, ":selected_banner_spr"),
						#  (str_store_troop_name, s7, l.cur_troop),
						#  (display_message, "@DEBUGS : {s7}'s banner is changed"),
						#  (troop_set_slot, l.cur_troop, slot_troop_banner_scene_prop, banner_scene_props_end_minus_one),
						#  (assign, l.end_cond, 0),
						#(try_end),
						...
						(assign, l.end_cond, active_npcs_end),
						(try_for_range, l.cur_troop, active_npcs_begin, l.end_cond),
							(troop_slot_eq, l.cur_troop, slot_troop_banner_scene_prop, ":selected_banner_spr"),
							(assign, ":troop_to_change", l.cur_troop),
							(assign, l.end_cond, 0),
							(troop_set_slot, l.cur_troop, slot_troop_banner_scene_prop, banner_scene_props_end_minus_one),
							(troop_get_slot, ":cur_party", l.cur_troop, slot_troop_leaded_party),
							(gt, ":cur_party", 0),
		...
		[
			(ti_on_presentation_load,
				[
					...
					(create_image_button_overlay_with_tableau_material, "$g_presentation_obj_custom_banner_22", mesh.color_picker, "tableau_color_picker", ":bg_color_1"),
					(create_image_button_overlay_with_tableau_material, "$g_presentation_obj_custom_banner_23", mesh.color_picker, "tableau_color_picker", ":bg_color_2"),
					(position_set_x, pos1, 200),
					(position_set_y, pos1, 565),
					...
					(try_begin),
						(eq, ":map_flag_type", mesh.custom_map_banner_01),
					...
					(else_try),
						(eq, ":map_flag_type", mesh.custom_map_banner_02),
					...
					(try_begin),
						...
						(create_image_button_overlay_with_tableau_material, "$g_presentation_obj_custom_banner_28", mesh.color_picker, "tableau_color_picker", ":cur_charge_color"),
						(position_set_x, pos1, 530),
						(position_set_y, pos1, 255),
					...
					(try_begin),
						...
						(create_image_button_overlay_with_tableau_material, "$g_presentation_obj_custom_banner_29", mesh.color_picker, "tableau_color_picker", ":cur_charge_color"),
						(position_set_x, pos1, 530),
						(position_set_y, pos1, 195),
					...
					(try_begin),
						...
						(create_image_button_overlay_with_tableau_material, "$g_presentation_obj_custom_banner_30", mesh.color_picker, "tableau_color_picker", ":cur_charge_color"),
						(position_set_x, pos1, 530),
						(position_set_y, pos1, 135),
					...
					(try_begin),
						...
						(create_image_button_overlay_with_tableau_material, "$g_presentation_obj_custom_banner_31", mesh.color_picker, "tableau_color_picker", ":cur_charge_color"),
						(position_set_x, pos1, 530),
						(position_set_y, pos1, 75),
			...
			(ti_on_presentation_event_state_change,
				[
					...
					(troop_get_slot, ":num_charges", "trp_player", slot_troop_custom_banner_num_charges),
					(try_begin),
						(this_or_next|eq, l.object, "$g_presentation_obj_custom_banner_2"),
						(eq, l.object, "$g_presentation_obj_custom_banner_22"),
					...
					(else_try),
						(this_or_next|eq, l.object, "$g_presentation_obj_custom_banner_3"),
						(eq, l.object, "$g_presentation_obj_custom_banner_23"),
						(assign, "$g_presentation_next_presentation", "prsnt_custom_banner"),
						(assign, "$g_presentation_output_slot", slot_troop_custom_banner_bg_color_2),
						(start_presentation, "prsnt_color_selection"),
					(else_try),
						(this_or_next|eq, l.object, "$g_presentation_obj_custom_banner_4"),
						(eq, l.object, "$g_presentation_obj_custom_banner_1"),
						(assign, "$g_presentation_next_presentation", "prsnt_custom_banner"),
						(start_presentation, "prsnt_banner_background_selection"),
					(else_try),
						(eq, l.object, "$g_presentation_obj_custom_banner_5"),
						(assign, "$g_presentation_next_presentation", "prsnt_custom_banner"),
						(start_presentation, "prsnt_banner_flag_type_selection"),
					(else_try),
						(ge, ":num_charges", 1),
						(this_or_next|eq, l.object, "$g_presentation_obj_custom_banner_6"),
						(eq, l.object, "$g_presentation_obj_custom_banner_24"),
						(assign, "$g_presentation_next_presentation", "prsnt_custom_banner"),
						(assign, "$g_presentation_output_slot", slot_troop_custom_banner_charge_type_1),
						(start_presentation, "prsnt_banner_charge_selection"),
					(else_try),
						(ge, ":num_charges", 1),
						(this_or_next|eq, l.object, "$g_presentation_obj_custom_banner_7"),
						(eq, l.object, "$g_presentation_obj_custom_banner_28"),
						(assign, "$g_presentation_next_presentation", "prsnt_custom_banner"),
						(assign, "$g_presentation_output_slot", slot_troop_custom_banner_charge_color_1),
						(start_presentation, "prsnt_color_selection"),
					(else_try),
						(ge, ":num_charges", 2),
						(this_or_next|eq, l.object, "$g_presentation_obj_custom_banner_8"),
						(eq, l.object, "$g_presentation_obj_custom_banner_25"),
						(assign, "$g_presentation_next_presentation", "prsnt_custom_banner"),
						(assign, "$g_presentation_output_slot", slot_troop_custom_banner_charge_type_2),
						(start_presentation, "prsnt_banner_charge_selection"),
					(else_try),
						(ge, ":num_charges", 2),
						(this_or_next|eq, l.object, "$g_presentation_obj_custom_banner_9"),
						(eq, l.object, "$g_presentation_obj_custom_banner_29"),
						(assign, "$g_presentation_next_presentation", "prsnt_custom_banner"),
						(assign, "$g_presentation_output_slot", slot_troop_custom_banner_charge_color_2),
						(start_presentation, "prsnt_color_selection"),
					(else_try),
						(ge, ":num_charges", 3),
						(this_or_next|eq, l.object, "$g_presentation_obj_custom_banner_10"),
						(eq, l.object, "$g_presentation_obj_custom_banner_26"),
						(assign, "$g_presentation_next_presentation", "prsnt_custom_banner"),
						(assign, "$g_presentation_output_slot", slot_troop_custom_banner_charge_type_3),
						(start_presentation, "prsnt_banner_charge_selection"),
					(else_try),
						(ge, ":num_charges", 3),
						(this_or_next|eq, l.object, "$g_presentation_obj_custom_banner_11"),
						(eq, l.object, "$g_presentation_obj_custom_banner_30"),
						(assign, "$g_presentation_next_presentation", "prsnt_custom_banner"),
						(assign, "$g_presentation_output_slot", slot_troop_custom_banner_charge_color_3),
						(start_presentation, "prsnt_color_selection"),
					(else_try),
						(ge, ":num_charges", 4),
						(this_or_next|eq, l.object, "$g_presentation_obj_custom_banner_12"),
						(eq, l.object, "$g_presentation_obj_custom_banner_27"),
						(assign, "$g_presentation_next_presentation", "prsnt_custom_banner"),
						(assign, "$g_presentation_output_slot", slot_troop_custom_banner_charge_type_4),
						(start_presentation, "prsnt_banner_charge_selection"),
					(else_try),
						(ge, ":num_charges", 4),
						(this_or_next|eq, l.object, "$g_presentation_obj_custom_banner_13"),
						(eq, l.object, "$g_presentation_obj_custom_banner_31"),
						(assign, "$g_presentation_next_presentation", "prsnt_custom_banner"),
						(assign, "$g_presentation_output_slot", slot_troop_custom_banner_charge_color_4),
						(start_presentation, "prsnt_color_selection"),
					(else_try),
						(ge, ":num_charges", 1),
						(eq, l.object, "$g_presentation_obj_custom_banner_14"),
						(assign, "$g_presentation_next_presentation", "prsnt_custom_banner"),
						(start_presentation, "prsnt_banner_charge_positioning"),
					(else_try),
						(eq, l.object, "$g_presentation_obj_custom_banner_15"),
						(troop_get_slot, ":num_charges", "trp_player", slot_troop_custom_banner_num_charges),
					...
					(else_try),
						(eq, l.object, "$g_presentation_obj_custom_banner_21"),
						(troop_get_slot, ":num_charges", "trp_player", slot_troop_custom_banner_num_charges),
						...
						(start_presentation, "prsnt_custom_banner"),
					(else_try),
						(eq, l.object, "$g_presentation_obj_custom_banner_16"),
						(call_script, "script_get_random_custom_banner", "trp_player"),
						(start_presentation, "prsnt_custom_banner"),
					(else_try),
						(eq, l.object, "$g_presentation_obj_custom_banner_17"),
						(assign, "$g_presentation_next_presentation", "prsnt_custom_banner"),
						(start_presentation, "prsnt_banner_flag_type_selection"),
					(else_try),
						(eq, l.object, "$g_presentation_obj_custom_banner_18"),
						(assign, "$g_presentation_next_presentation", "prsnt_custom_banner"),
						(start_presentation, "prsnt_banner_flag_map_type_selection"),
					(else_try),
						(eq, l.object, "$g_presentation_obj_custom_banner_19"),
						(assign, "$g_presentation_next_presentation", "prsnt_custom_banner"),
						(start_presentation, "prsnt_banner_flag_map_type_selection"),
					(else_try),
						(eq, l.object, "$g_presentation_obj_custom_banner_32"),
						...
						(start_presentation, "prsnt_custom_banner"),
					(else_try),
						(eq, l.object, "$g_presentation_obj_custom_banner_34"),
						...
						(start_presentation, "prsnt_custom_banner"),
					(else_try),
						(eq, l.object, "$g_presentation_obj_custom_banner_36"),
						...
						(start_presentation, "prsnt_custom_banner"),
					(else_try),
						(eq, l.object, "$g_presentation_obj_custom_banner_38"),
						...
						(start_presentation, "prsnt_custom_banner"),
					(else_try),
						(eq, l.object, "$g_presentation_obj_custom_banner_33"),
						(troop_get_slot, ":charge_type", "trp_player", slot_troop_custom_banner_charge_type_1),
						...
						(start_presentation, "prsnt_custom_banner"),
					(else_try),
						(eq, l.object, "$g_presentation_obj_custom_banner_35"),
						(troop_get_slot, ":charge_type", "trp_player", slot_troop_custom_banner_charge_type_2),
						(store_div, ":flag", ":charge_type", 512),
						(val_add, ":flag", 1),
						(val_mod, ":flag", 2), #switch flag
						...
						(start_presentation, "prsnt_custom_banner"),
					(else_try),
						(eq, l.object, "$g_presentation_obj_custom_banner_37"),
						(troop_get_slot, ":charge_type", "trp_player", slot_troop_custom_banner_charge_type_3),
						(store_div, ":flag", ":charge_type", 512),
						(val_add, ":flag", 1),
						(val_mod, ":flag", 2), #switch flag
						...
						(start_presentation, "prsnt_custom_banner"),
					(else_try),
						(eq, l.object, "$g_presentation_obj_custom_banner_39"),
						(troop_get_slot, ":charge_type", "trp_player", slot_troop_custom_banner_charge_type_4),
						(store_div, ":flag", ":charge_type", 512),
						(val_add, ":flag", 1),
						(val_mod, ":flag", 2), #switch flag
						...
						(start_presentation, "prsnt_custom_banner"),
					(else_try),
						(eq, l.object, "$g_presentation_obj_custom_banner_20"),
			...
			(ti_on_presentation_event_state_change,
				[
					...
					(try_for_range, ":trp_slot_index", 0, ":num_positionings"),
						(troop_slot_eq, "trp_temp_array_a", ":trp_slot_index", l.object),
	...
	("banner_charge_selection", 0, mesh.load_window,
		[
			...
			(ti_on_presentation_event_state_change,
				[
					(store_trigger_param_1, l.object),
					(assign, l.end_cond, custom_banner_charges_end),
					(val_sub, l.end_cond, custom_banner_charges_begin),
					(try_for_range, ":trp_slot_index", 0, l.end_cond),
						(troop_slot_eq, "trp_temp_array_a", ":trp_slot_index", l.object),
	...
	("banner_background_selection", 0, mesh.load_window,
		[
			...
			(ti_on_presentation_event_state_change,
				[
					(store_trigger_param_1, l.object),
					(assign, l.end_cond, custom_banner_backgrounds_end),
					(val_sub, l.end_cond, custom_banner_backgrounds_begin),
					(try_for_range, ":trp_slot_index", 0, l.end_cond),
						(troop_slot_eq, "trp_temp_array_a", ":trp_slot_index", l.object),
	...
	("banner_flag_type_selection", 0, mesh.load_window,
		[
			...
			(ti_on_presentation_event_state_change,
				[
					(store_trigger_param_1, l.object),
					(assign, l.end_cond, custom_banner_flag_types_end),
					(val_sub, l.end_cond, custom_banner_flag_types_begin),
					(try_for_range, ":trp_slot_index", 0, l.end_cond),
						(troop_slot_eq, "trp_temp_array_a", ":trp_slot_index", l.object),
	...
	("banner_flag_map_type_selection", 0, mesh.load_window,
		[
			...
			(ti_on_presentation_event_state_change,
				[
					(store_trigger_param_1, l.object),
					(assign, l.end_cond, custom_banner_flag_map_types_end),
					(val_sub, l.end_cond, custom_banner_flag_map_types_begin),
					(try_for_range, ":trp_slot_index", 0, l.end_cond),
						(troop_slot_eq, "trp_temp_array_a", ":trp_slot_index", l.object),
	...
	("color_selection", 0, mesh.load_window,
		[
			(ti_on_presentation_load,
				[
					...
					(try_for_range, ":i_color", 0, 42),
						...
						(create_image_button_overlay_with_tableau_material, reg1, mesh.color_picker, "tableau_color_picker", ":cur_color"),
						(position_set_x, pos1, ":pos_x"),
						(position_set_y, pos1, ":pos_y"),
						(val_add, ":pos_x", 50),
						(try_begin),
			...
			(ti_on_presentation_event_state_change,
				[
					(store_trigger_param_1, l.object),
					(assign, l.end_cond, 64),
					(try_for_range, ":i_color", 0, l.end_cond),
						(store_mul, ":trp_slot_index", ":i_color", 2),
						(troop_slot_eq, "trp_temp_array_a", ":trp_slot_index", l.object),
						(store_add, ":trp_slot_color", ":trp_slot_index", 1),
		...
		[
				...
				[
					...
					(else_try),
						...
						(try_for_range_backwards, ":loop_var", "trp_kingdom_heroes_including_player_begin", active_npcs_end),
							(ge, ":cur_index", 0),
							(assign, l.cur_troop, ":loop_var"),
							(assign, ":continue", 0),
							(try_begin),
								(eq, ":loop_var", "trp_kingdom_heroes_including_player_begin"),
								(assign, l.cur_troop, "trp_player"),
								(try_begin),
									(eq, "$g_player_is_captive", 0),
									(assign, ":continue", 1),
								(try_end),
							(else_try),
								(store_troop_faction, ":cur_troop_faction", l.cur_troop),
								(eq, "$players_kingdom", ":cur_troop_faction"),
								#(troop_slot_eq, l.cur_troop, slot_troop_is_prisoner, 0),
								(neg|troop_slot_ge, l.cur_troop, slot_troop_prisoner_of_party, 0),
								(troop_slot_ge, l.cur_troop, slot_troop_leaded_party, 1),
								(troop_slot_eq, l.cur_troop, slot_troop_occupation, slto_kingdom_hero),
								(neg|faction_slot_eq, ":cur_troop_faction", slot_faction_leader, l.cur_troop),
								(assign, ":continue", 1),
							(try_end),
							(eq, ":continue", 1),

							(neq, "$g_presentation_marshall_selection_max_renown_1_troop", l.cur_troop),
							(neq, "$g_presentation_marshall_selection_max_renown_2_troop", l.cur_troop),
							...
							(create_mesh_overlay_with_tableau_material, reg1, -1, "tableau_troop_note_mesh", l.cur_troop),
							(position_set_x, pos1, 300),
							(position_set_y, pos1, 300),
							(overlay_set_size, reg1, pos1),
							...
							(else_try),
								(str_store_troop_name, s1, l.cur_troop),
			...
			(ti_on_presentation_event_state_change,
				[
					(store_trigger_param_1, l.object),
					(try_begin),
						(eq, l.object, "$g_presentation_obj_marshall_selection_2"),
						(val_add, "$g_presentation_marshall_selection_1_vote", 1),
					...
					(else_try),
						(eq, l.object, "$g_presentation_obj_marshall_selection_3"),
						(val_add, "$g_presentation_marshall_selection_2_vote", 1),
						(call_script, "script_change_player_relation_with_troop", "$g_presentation_marshall_selection_max_renown_1_troop", -2),
						(call_script, "script_change_player_relation_with_troop", "$g_presentation_marshall_selection_max_renown_2_troop", 2),
					(try_end),
					(try_begin),
						(this_or_next|eq, l.object, "$g_presentation_obj_marshall_selection_1"),
						(this_or_next|eq, l.object, "$g_presentation_obj_marshall_selection_2"),
						(eq, l.object, "$g_presentation_obj_marshall_selection_3"),
						(try_begin),
	...
	("battle",0,0,[
			(ti_on_presentation_load,
				[(set_fixed_point_multiplier, 1000),
					...
					(try_begin),
						...
						(create_image_button_overlay, "$g_presentation_obj_battle_but0", mesh.white_plane, mesh.white_plane),
						...
						(create_check_box_overlay, "$g_presentation_obj_battle_check0", mesh.checkbox_off, mesh.checkbox_on),
					...
					(try_begin),
						...
						(create_image_button_overlay, "$g_presentation_obj_battle_but1", mesh.white_plane, mesh.white_plane),
						(position_set_x, pos1, ":stat_position_x"),
						(position_set_y, pos1, ":stat_position_y"),
						...
						(create_check_box_overlay, "$g_presentation_obj_battle_check1", mesh.checkbox_off, mesh.checkbox_on),
						(position_set_x, pos2, ":stat_position_check_x"),
						(position_set_y, pos2, ":stat_position_check_y"),
					...
					(try_begin),
						...
						(create_image_button_overlay, "$g_presentation_obj_battle_but2", mesh.white_plane, mesh.white_plane),
						(position_set_x, pos1, ":stat_position_x"),
						(position_set_y, pos1, ":stat_position_y"),
						...
						(create_check_box_overlay, "$g_presentation_obj_battle_check2", mesh.checkbox_off, mesh.checkbox_on),
						(position_set_x, pos2, ":stat_position_check_x"),
						(position_set_y, pos2, ":stat_position_check_y"),
					...
					(try_begin),
						...
						(create_image_button_overlay, "$g_presentation_obj_battle_but3", mesh.white_plane, mesh.white_plane),
						(position_set_x, pos1, ":stat_position_x"),
						(position_set_y, pos1, ":stat_position_y"),
						...
						(create_check_box_overlay, "$g_presentation_obj_battle_check3", mesh.checkbox_off, mesh.checkbox_on),
						(position_set_x, pos2, ":stat_position_check_x"),
						(position_set_y, pos2, ":stat_position_check_y"),
					...
					(try_begin),
						...
						(create_image_button_overlay, "$g_presentation_obj_battle_but4", mesh.white_plane, mesh.white_plane),
						(position_set_x, pos1, ":stat_position_x"),
						(position_set_y, pos1, ":stat_position_y"),
						...
						(create_check_box_overlay, "$g_presentation_obj_battle_check4", mesh.checkbox_off, mesh.checkbox_on),
						(position_set_x, pos2, ":stat_position_check_x"),
						(position_set_y, pos2, ":stat_position_check_y"),
					...
					(try_begin),
						...
						(create_image_button_overlay, "$g_presentation_obj_battle_but5", mesh.white_plane, mesh.white_plane),
						(position_set_x, pos1, ":stat_position_x"),
						(position_set_y, pos1, ":stat_position_y"),
						...
						(create_check_box_overlay, "$g_presentation_obj_battle_check5", mesh.checkbox_off, mesh.checkbox_on),
						(position_set_x, pos2, ":stat_position_check_x"),
						(position_set_y, pos2, ":stat_position_check_y"),
					...
					(try_begin),
						...
						(create_image_button_overlay, "$g_presentation_obj_battle_but6", mesh.white_plane, mesh.white_plane),
						(position_set_x, pos1, ":stat_position_x"),
						(position_set_y, pos1, ":stat_position_y"),
						...
						(create_check_box_overlay, "$g_presentation_obj_battle_check6", mesh.checkbox_off, mesh.checkbox_on),
						(position_set_x, pos2, ":stat_position_check_x"),
						(position_set_y, pos2, ":stat_position_check_y"),
					...
					(try_begin),
						...
						(create_image_button_overlay, "$g_presentation_obj_battle_but7", mesh.white_plane, mesh.white_plane),
						(position_set_x, pos1, ":stat_position_x"),
						(position_set_y, pos1, ":stat_position_y"),
						...
						(create_check_box_overlay, "$g_presentation_obj_battle_check7", mesh.checkbox_off, mesh.checkbox_on),
						(position_set_x, pos2, ":stat_position_check_x"),
						(position_set_y, pos2, ":stat_position_check_y"),
					...
					(try_begin),
						...
						(create_image_button_overlay, "$g_presentation_obj_battle_but8", mesh.white_plane, mesh.white_plane),
						(position_set_x, pos1, ":stat_position_x"),
						(position_set_y, pos1, ":stat_position_y"),
						...
						(create_check_box_overlay, "$g_presentation_obj_battle_check8", mesh.checkbox_off, mesh.checkbox_on),
						(position_set_x, pos2, ":stat_position_check_x"),
						(position_set_y, pos2, ":stat_position_check_y"),
					...
					(create_image_button_overlay, "$g_battle_report_plane", mesh.white_plane, mesh.white_plane),
					...
					(create_image_button_overlay, "$g_battle_map_plane", mesh.white_plane, mesh.white_plane),
					...
					(create_mesh_overlay, "$g_battle_map_infantry_order_flag", mesh.flag_infantry),
					(create_mesh_overlay, "$g_battle_map_archers_order_flag", mesh.flag_archers),
					(create_mesh_overlay, "$g_battle_map_cavalry_order_flag", mesh.flag_cavalry),
			...
			(ti_on_presentation_event_state_change,
				[(store_trigger_param_1, l.object),
					...
					(try_begin),
						(eq, "$group0_has_troops", 1),
						(eq, l.object, "$g_presentation_obj_battle_check0"),
						(assign, ":update_listeners", 1),
						(assign, "$g_formation_group0_selected", l.value),
						(try_begin),
							(eq, l.value, 1),
					...
					(else_try),
						(eq, "$group1_has_troops", 1),
						(eq, l.object, "$g_presentation_obj_battle_check1"),
						(assign, ":update_listeners", 1),
						(assign, "$g_formation_group1_selected", l.value),
						(try_begin),
							(eq, l.value, 1),
					...
					(else_try),
						(eq, "$group2_has_troops", 1),
						(eq, l.object, "$g_presentation_obj_battle_check2"),
						(assign, ":update_listeners", 1),
						(assign, "$g_formation_group2_selected", l.value),
						(try_begin),
							(eq, l.value, 1),
					...
					(else_try),
						(eq, "$group3_has_troops", 1),
						(eq, l.object, "$g_presentation_obj_battle_check3"),
						(assign, ":update_listeners", 1),
						(assign, "$g_formation_group3_selected", l.value),
						(try_begin),
							(eq, l.value, 1),
					...
					(else_try),
						(eq, "$group4_has_troops", 1),
						(eq, l.object, "$g_presentation_obj_battle_check4"),
						(assign, ":update_listeners", 1),
						(assign, "$g_formation_group4_selected", l.value),
						(try_begin),
							(eq, l.value, 1),
					...
					(else_try),
						(eq, "$group5_has_troops", 1),
						(eq, l.object, "$g_presentation_obj_battle_check5"),
						(assign, ":update_listeners", 1),
						(assign, "$g_formation_group5_selected", l.value),
						(try_begin),
							(eq, l.value, 1),
					...
					(else_try),
						(eq, "$group6_has_troops", 1),
						(eq, l.object, "$g_presentation_obj_battle_check6"),
						(assign, ":update_listeners", 1),
						(assign, "$g_formation_group6_selected", l.value),
						(try_begin),
							(eq, l.value, 1),
					...
					(else_try),
						(eq, "$group7_has_troops", 1),
						(eq, l.object, "$g_presentation_obj_battle_check7"),
						(assign, ":update_listeners", 1),
						(assign, "$g_formation_group7_selected", l.value),
						(try_begin),
							(eq, l.value, 1),
					...
					(else_try),
						(eq, "$group8_has_troops", 1),
						(eq, l.object, "$g_presentation_obj_battle_check8"),
						(assign, ":update_listeners", 1),
						(assign, "$g_formation_group8_selected", l.value),
						(try_begin),
							(eq, l.value, 1),
						...
						(try_end),
					(else_try),
						(eq, l.object, "$g_presentation_obj_battle_but0"),
						(assign, ":update_listeners", 1),
						...
						(try_end),
					(else_try),
						(eq, l.object, "$g_presentation_obj_battle_but1"),
						(assign, ":update_listeners", 1),
						...
						(try_end),
					(else_try),
						(eq, l.object, "$g_presentation_obj_battle_but2"),
						(assign, ":update_listeners", 1),
						...
						(try_end),
					(else_try),
						(eq, l.object, "$g_presentation_obj_battle_but3"),
						(assign, ":update_listeners", 1),
						...
						(try_end),
					(else_try),
						(eq, l.object, "$g_presentation_obj_battle_but4"),
						(assign, ":update_listeners", 1),
						...
						(try_end),
					(else_try),
						(eq, l.object, "$g_presentation_obj_battle_but5"),
						(assign, ":update_listeners", 1),
						...
						(try_end),
					(else_try),
						(eq, l.object, "$g_presentation_obj_battle_but6"),
						(assign, ":update_listeners", 1),
						...
						(try_end),
					(else_try),
						(eq, l.object, "$g_presentation_obj_battle_but7"),
						(assign, ":update_listeners", 1),
						...
						(try_end),
					(else_try),
						(eq, l.object, "$g_presentation_obj_battle_but8"),
						(assign, ":update_listeners", 1),
					...
					(else_try),
						...
						(try_end),
					(else_try),
						(eq, l.object, "$g_presentation_obj_battle_11"),
						(try_begin),
							(eq, l.value, 1),
						...
						(try_end),
					(else_try),
						(eq, l.object, "$g_presentation_obj_battle_12"),
						(try_begin),
							(eq, l.value, 1),
						...
						(try_end),
					(else_try),
						(eq, l.object, "$g_presentation_obj_battle_13"),
						(try_begin),
							(eq, l.value, 1),
						...
						(try_end),
					(else_try),
						(eq, l.object, "$g_battle_map_plane"),
						(get_scene_boundaries, pos2, pos3),
	...
	("sliders",0,0,[
			...
			(ti_on_presentation_event_state_change,
				[(store_trigger_param_1, l.object),
					...
					(try_begin),
						(eq, l.object, "$g_presentation_obj_sliders_1"),
						(try_begin),
							(neq, "$g_presentation_obj_sliders_1_val", l.value),
							(assign, "$g_presentation_obj_sliders_1_val", l.value),
							(assign, ":val_changed", 1),
						(try_end),
					(else_try),
						(eq, l.object, "$g_presentation_obj_sliders_2"),
						(try_begin),
							(neq, "$g_presentation_obj_sliders_2_val", l.value),
							(assign, "$g_presentation_obj_sliders_2_val", l.value),
							(assign, ":val_changed", 1),
						(try_end),
					(else_try),
						(eq, l.object, "$g_presentation_obj_sliders_3"),
						(try_begin),
							(neq, "$g_presentation_obj_sliders_3_val", l.value),
							(assign, "$g_presentation_obj_sliders_3_val", l.value),
							(assign, ":val_changed", 1),
						(try_end),
					(else_try),
						(eq, l.object, "$g_presentation_obj_sliders_4"),
						(try_begin),
							(neq, "$g_presentation_obj_sliders_4_val", l.value),
							(assign, "$g_presentation_obj_sliders_4_val", l.value),
							(assign, ":val_changed", 1),
						(try_end),
					(try_end),
					(try_begin),
						...
						(try_end),
						(store_sub, ":sum_non_changed_values", ":sum_values", l.value),
						(val_add, ":sum_non_changed_values", 30),
						(try_for_range, l.unused, 0, ":difference"),
							(store_random_in_range, l.random_no, 0, ":sum_non_changed_values"),
							(try_begin),
								(neq, l.object, "$g_presentation_obj_sliders_1"),
								(val_sub, l.random_no, "$g_presentation_obj_sliders_1_val"),
								(val_sub, l.random_no, 10),
								(lt, l.random_no, 0),
								(is_between, ":obj_1_new_val", ":between_1", ":between_2"),
								(val_add, ":obj_1_new_val", ":adder"),
							(else_try),
								(neq, l.object, "$g_presentation_obj_sliders_2"),
								(val_sub, l.random_no, "$g_presentation_obj_sliders_2_val"),
								(val_sub, l.random_no, 10),
								(lt, l.random_no, 0),
								(is_between, ":obj_2_new_val", ":between_1", ":between_2"),
								(val_add, ":obj_2_new_val", ":adder"),
							(else_try),
								(neq, l.object, "$g_presentation_obj_sliders_3"),
								(val_sub, l.random_no, "$g_presentation_obj_sliders_3_val"),
								(val_sub, l.random_no, 10),
								(lt, l.random_no, 0),
		...
		[
			(ti_on_presentation_load,
				[
					...
					(try_for_range, l.troop_no, heroes_begin, heroes_end),
						(this_or_next|troop_slot_eq, l.troop_no, slot_troop_occupation, slto_kingdom_hero),
						(troop_slot_eq, l.troop_no, slot_troop_occupation, slto_kingdom_lady),
						(call_script, "script_troop_get_player_relation", l.troop_no),
						(assign, ":relation", reg0),
						#(troop_get_slot, ":relation", l.troop_no, slot_troop_player_relation),
						(try_begin),
							(ge, ":relation", 40),
					...
					(try_for_range, l.troop_no, companions_begin, companions_end),
						(try_begin),
							(troop_slot_eq, l.troop_no, slot_troop_occupation, slto_player_companion),
							(val_add, ":num_companions_joined", 1),
						(else_try),
							(troop_slot_ge, l.troop_no, slot_troop_playerparty_history, 1),
			...
			(ti_on_presentation_event_state_change,
				[
					(store_trigger_param_1, l.object),
					(try_begin),
						(eq, l.object, "$g_presentation_obj_retirement_1"),
						(jump_to_menu, "mnu_end_game"),
						(start_presentation, "prsnt_game_credits"),
					(else_try),
						(eq, l.object, "$g_presentation_obj_retirement_2"),
						(presentation_set_duration, 0),
	...
	("budget_report", 0, mesh.load_window,
		[(ti_on_presentation_load,
				[(presentation_set_duration, 999999),
					...
					(try_end),
					(val_add, ":num_lines", 3),
					(store_mul, l.cur_y, 27, ":num_lines"),
					...
					(try_for_range, ":center_no", centers_begin, centers_end),
						...
						(try_begin),
							...
							(try_begin),
								(store_faction_of_party, l.faction_no, ":center_no"),
								(store_relation, ":relation", l.faction_no, "$players_kingdom"),
								(lt, ":relation", 0),
								(assign, reg0, 0),
								(assign, ":net_profit", 0),
			...
			(ti_on_presentation_event_state_change,
				[(store_trigger_param_1, l.object),
					(try_begin),
						(eq, l.object, "$g_presentation_obj_budget_report_1"),
						(presentation_set_duration, 0),
					(try_end),
					]),
			]),
	...
	("multiplayer_flag_projection_display_ccoop", prsntf_read_only|prsntf_manual_end_only, 0, [
			(ti_on_presentation_load,
				[
					...
					(create_mesh_overlay, "$g_presentation_obj_flag_projection_display_1", mesh.prison_cart_pos),
			...
			(ti_on_presentation_load,
				[
					...
					(try_begin),
						...
						(create_mesh_overlay, "$g_presentation_obj_flag_projection_display_1", mesh.incoming_enemy),
						(position_set_x, pos1, 250),
						(position_set_y, pos1, 250),
						(overlay_set_size, "$g_presentation_obj_flag_projection_display_1", pos1),
						(overlay_set_display, "$g_presentation_obj_flag_projection_display_1", 0),
					...
					(try_begin),
						...
						(create_mesh_overlay, "$g_presentation_obj_flag_projection_display_2", mesh.incoming_enemy),
						(position_set_x, pos1, 250),
						(position_set_y, pos1, 250),
						(overlay_set_size, "$g_presentation_obj_flag_projection_display_2", pos1),
						(overlay_set_display, "$g_presentation_obj_flag_projection_display_2", 0),
			...
			(ti_on_presentation_event_state_change,
				[(store_trigger_param_1, l.object),
					...
					(else_try),
						...
						(presentation_set_duration, 0),
					(else_try),
						(eq, l.object, "$g_presentation_obj_coop_assign_drop_companion_2"),
						...
						(presentation_set_duration, 0),
					(else_try),
						(eq, l.object, "$g_presentation_obj_coop_assign_drop_noone"),
	...
	# 				(val_add,":check", 1),
	# 				(eq, ":overlay", ":check"),
	# 				(assign, "$g_lwbr_dmg_report", l.value),#"Dmg report Enabled" checkbox
	# 			(else_try),
	# 				(val_add,":check", 1),
	# 				(eq, ":overlay", ":check"),
	...
	# 				(val_add,":check", 1),
	# 				(eq, ":overlay", ":check"),
	# 				(assign, "$g_lwbr_keep_selected_items", l.value),#"'Keep selected items' Enabled." checkbox
	...
	# 				(val_add,":check", 1),
	# 				(eq, ":overlay", ":check"),
	# 				(assign, "$g_lwbr_firearms_enabled", l.value),#"Firearms Enabled" checkbox
	# 				(multiplayer_send_3_int_to_server, multiplayer_event_lwbr_server, lwbr_server_set_var, lwbr_var_firearms_enabled, l.value),
	# 			(else_try),
	# 				(val_add,":check", 1),
	# 				(eq, ":overlay", ":check"),
	...
	# 				(val_add,":check", 1),
	# 				(eq, ":overlay", ":check"),
	# 				(assign, "$g_lwbr_horse_enabled", l.value),#"Horses Enabled" checkbox
	# 				(multiplayer_send_3_int_to_server, multiplayer_event_lwbr_server, lwbr_server_set_var, lwbr_var_horses_enabled, l.value),
	# 			(else_try),
	# 				(val_add,":check", 1),
	# 				(eq, ":overlay", ":check"),
	...
	# 				(val_add,":check", 1),
	# 				(eq, ":overlay", ":check"),
	# 				(assign, "$g_lwbr_peasants_enabled", l.value),#"Peasants Enabled" checkbox
	# 				(multiplayer_send_3_int_to_server, multiplayer_event_lwbr_server, lwbr_server_set_var, lwbr_var_peasants_enabled, l.value),
	# 			(else_try),
	# 				(val_add,":check", 1),
	# 				(eq, ":overlay", ":check"),
	...
	# 				(val_add,":check", 1),
	# 				(eq, ":overlay", ":check"),
	# 				(assign, "$lwbr_g_firearms_enabled", l.value),#"Persistent Stats" checkbox
	# 				(multiplayer_send_3_int_to_server, multiplayer_event_lwbr_server, lwbr_server_set_var, lwbr_var_persistant_stats, l.value),
	# 			(else_try),
	# 				(val_add,":check", 1),
	# 				(eq, ":overlay", ":check"),
	...
	# 				(val_add,":check", 1),
	# 				(eq, ":overlay", ":check"),
	# 				(assign, "$g_jump_from_horse", l.value),#"Jumping from horse Enabled" checkbox
	# 				(multiplayer_send_3_int_to_server, multiplayer_event_lwbr_server, lwbr_server_set_var, lwbr_var_jump_from_horse, l.value),
	# 			(else_try),
	# 				(val_add,":check", 1),
	# 				(eq, ":overlay", ":check"),
	...
	# 				(val_add,":check", 1),
	# 				(eq, ":overlay", ":check"),
	# 				(assign, "$g_taunt", l.value),#"Taunting Enabled" checkbox
	# 				(multiplayer_send_3_int_to_server, multiplayer_event_lwbr_server, lwbr_server_set_var, lwbr_var_taunt, l.value),
	# 			(else_try),
	# 				(val_add,":check", 1),
	# 				(eq, ":overlay", ":check"),
	...
	# 				(val_add,":check", 1),
	# 				(eq, ":overlay", ":check"),
	# 				(assign, "$g_cheer", l.value),#"Cheering Enabled" checkbox
	# 				(multiplayer_send_3_int_to_server, multiplayer_event_lwbr_server, lwbr_server_set_var, lwbr_var_cheer, l.value),
	# 			(else_try),
	# 				(val_add,":check", 1),
	# 				(eq, ":overlay", ":check"),
	...
	# 				(val_add,":check", 1),
	# 				(eq, ":overlay", ":check"),
	# 				(assign, "$g_lwbr_1_free_wpn", l.value),#"'Only one FREE weapon' Enabled." checkbox
	# 				(multiplayer_send_3_int_to_server, multiplayer_event_lwbr_server, lwbr_server_set_var, lwbr_var_1_free_wpn, l.value),
	# 			(else_try),
	# 				(val_add,":check", 1),
	# 				(eq, ":overlay", ":check"),
	...
	# 				(val_add,":check", 1),
	# 				(eq, ":overlay", ":check"),
	# 				(assign, "$g_min_version_required", l.value),#"Min Version Required" numbox
	# 				(multiplayer_send_3_int_to_server, multiplayer_event_lwbr_server, lwbr_server_set_var, lwbr_var_min_version_required, l.value),
	# 			(else_try),
	# 				(val_add,":check", 1),
	# 				(eq, ":overlay", ":check"),
	...
	# 				(val_add,":check", 1),
	# 				(eq, ":overlay", ":check"),
	# 				(assign, "$g_lwbr_sv_messaage_cd_min", l.value),#"Time between server Messages(min)" numbox
	# 				(multiplayer_send_3_int_to_server, multiplayer_event_lwbr_server, lwbr_server_set_var, lwbr_var_sv_message_cd_min, l.value),
	# 			(else_try),
	# 				(val_add,":check", 1),
	# 				(eq, ":overlay", ":check"),
	...
	# 				(val_add,":check", 1),
	# 				(eq, ":overlay", ":check"),
	# 				(assign, "$g_lwbr_team_1_dmg_received", l.value),#"Team 1 Dmg receieved(%)" numbox
	# 				(multiplayer_send_3_int_to_server, multiplayer_event_lwbr_server, lwbr_server_set_var, lwbr_var_team_1_dmg_received, l.value),
	# 			(else_try),
	# 				(val_add,":check", 1),
	# 				(eq, ":overlay", ":check"),
	...
	# 				(val_add,":check", 1),
	# 				(eq, ":overlay", ":check"),
	# 				(assign, "$g_lwbr_team_1_dmg_dealt", l.value),#"Team 1 Dmg dealt(%)" numbox
	# 				(multiplayer_send_3_int_to_server, multiplayer_event_lwbr_server, lwbr_server_set_var, lwbr_var_team_1_dmg_dealt, l.value),
	# 			(else_try),
	# 				(val_add,":check", 1),
	# 				(eq, ":overlay", ":check"),
	...
	# 				(val_add,":check", 1),
	# 				(eq, ":overlay", ":check"),
	# 				(assign, "$g_lwbr_team_2_dmg_received", l.value),#"Team 2 Dmg receieved(%)" numbox
	# 				(multiplayer_send_3_int_to_server, multiplayer_event_lwbr_server, lwbr_server_set_var, lwbr_var_team_2_dmg_received, l.value),
	# 			(else_try),
	# 				(val_add,":check", 1),
	# 				(eq, ":overlay", ":check"),
	...
	# 				(val_add,":check", 1),
	# 				(eq, ":overlay", ":check"),
	# 				(assign, "$g_lwbr_team_2_dmg_dealt", l.value),#"Team 2 Dmg dealt(%)" numbox
	# 				(multiplayer_send_3_int_to_server, multiplayer_event_lwbr_server, lwbr_server_set_var, lwbr_var_team_2_dmg_dealt, l.value),
	# 			(else_try),
	# 				(val_add,":check", 1),
	# 				(eq, ":overlay", ":check"),#Items available
	# 				(assign,"$g_lwbr_new_items", l.value),
	# 				(try_begin),
	# 					(eq,l.value, 0),
	...
	# 				(try_end),
	# 				(assign, "$g_menu_rain_type", l.value),
	# 				(multiplayer_send_3_int_to_server, multiplayer_event_lwbr_server, lwbr_server_set_var, lwbr_var_menu_rain_type, l.value),
	# 				(try_begin),
	# 					(eq, lwbr_debug_mode, 1),
	...
	# 				(try_end),
	# 				(assign, "$g_menu_round_day_time", l.value),
	# 				(multiplayer_send_3_int_to_server, multiplayer_event_lwbr_server, lwbr_server_set_var, lwbr_var_menu_day_time, l.value),
	# 				(try_begin),
	# 					(eq, lwbr_debug_mode, 1),
	...
	# 				(try_end),
	# 				(assign, "$g_menu_fog_distance", l.value),
	# 				(multiplayer_send_3_int_to_server, multiplayer_event_lwbr_server, lwbr_server_set_var, lwbr_var_menu_fog_dist, l.value),
	# 				(try_begin),
	# 					(eq, lwbr_debug_mode, 1),
