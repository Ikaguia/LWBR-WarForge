...
mission_templates = [
		...
		[
			...
			(1, 0, 0,
				[
					...
					(neq, ":wielded_item", itm.throwing_spear_melee),
					(neq, ":wielded_item", itm.jarid_melee),
					(neq, ":wielded_item", itm.light_throwing_axes_melee),
					(neq, ":wielded_item", itm.throwing_axes_melee),
					(neq, ":wielded_item", itm.heavy_throwing_axes_melee),
					],
				[
					(party_get_slot, ":tavernkeeper", "$g_encountered_party", slot_town_tavernkeeper),
					(start_mission_conversation, ":tavernkeeper"),
	...
	##        (troop_remove_item, "trp_player", itm.tutorial_sword),
	##        (troop_remove_item, "trp_player", itm.tutorial_axe),
	##        (troop_remove_item, "trp_player", itm.tutorial_spear),
	##        (troop_remove_item, "trp_player", itm.tutorial_club),
	##        (troop_remove_item, "trp_player", itm.tutorial_battle_axe),
	##        (troop_remove_item, "trp_player", itm.tutorial_arrows),
	##        (troop_remove_item, "trp_player", itm.tutorial_bolts),
	##        (troop_remove_item, "trp_player", itm.tutorial_short_bow),
	##        (troop_remove_item, "trp_player", itm.tutorial_crossbow),
	##        (troop_remove_item, "trp_player", itm.tutorial_throwing_daggers),
	##
	...
	##
	##        (troop_remove_item, "trp_tutorial_chest_1", itm.tutorial_sword),
	##        (troop_remove_item, "trp_tutorial_chest_1", itm.tutorial_axe),
	##        (troop_remove_item, "trp_tutorial_chest_1", itm.tutorial_spear),
	##        (troop_remove_item, "trp_tutorial_chest_1", itm.tutorial_club),
	##        (troop_remove_item, "trp_tutorial_chest_1", itm.tutorial_battle_axe),
	##        (troop_remove_item, "trp_tutorial_chest_2", itm.tutorial_arrows),
	##        (troop_remove_item, "trp_tutorial_chest_2", itm.tutorial_bolts),
	##        (troop_remove_item, "trp_tutorial_chest_2", itm.tutorial_short_bow),
	##        (troop_remove_item, "trp_tutorial_chest_2", itm.tutorial_crossbow),
	##        (troop_remove_item, "trp_tutorial_chest_2", itm.tutorial_throwing_daggers),
	##        (troop_add_item, "trp_tutorial_chest_1", itm.tutorial_sword),
	##        (troop_add_item, "trp_tutorial_chest_1", itm.tutorial_axe),
	##        (troop_add_item, "trp_tutorial_chest_1", itm.tutorial_spear),
	##        (troop_add_item, "trp_tutorial_chest_1", itm.tutorial_club),
	##        (troop_add_item, "trp_tutorial_chest_1", itm.tutorial_battle_axe),
	##        (troop_add_item, "trp_tutorial_chest_2", itm.tutorial_arrows),
	##        (troop_add_item, "trp_tutorial_chest_2", itm.tutorial_bolts),
	##        (troop_add_item, "trp_tutorial_chest_2", itm.tutorial_short_bow),
	##        (troop_add_item, "trp_tutorial_chest_2", itm.tutorial_crossbow),
	##        (troop_add_item, "trp_tutorial_chest_2", itm.tutorial_throwing_daggers),
	##        ]
	##       ),
	##
	...
	##                       (try_begin),
	##                         (troop_has_item_equipped, "trp_player", itm.tutorial_sword),
	##                         (assign, "$tutorial_item_equipped", 1),
	##                       (else_try),
	##                         (troop_has_item_equipped, "trp_player", itm.tutorial_axe),
	##                         (assign, "$tutorial_item_equipped", 1),
	##                       (else_try),
	##                         (troop_has_item_equipped, "trp_player", itm.tutorial_spear),
	##                         (assign, "$tutorial_item_equipped", 1),
	##                       (else_try),
	##                         (troop_has_item_equipped, "trp_player", itm.tutorial_club),
	##                         (assign, "$tutorial_item_equipped", 1),
	##                       (else_try),
	##                         (troop_has_item_equipped, "trp_player", itm.tutorial_battle_axe),
	##                         (assign, "$tutorial_item_equipped", 1),
	##                       (else_try),
	##                         (troop_has_item_equipped, "trp_player", itm.tutorial_arrows),
	##                         (assign, "$tutorial_item_equipped", 1),
	##                       (else_try),
	##                         (troop_has_item_equipped, "trp_player", itm.tutorial_bolts),
	##                         (assign, "$tutorial_item_equipped", 1),
	##                       (else_try),
	##                         (troop_has_item_equipped, "trp_player", itm.tutorial_short_bow),
	##                         (assign, "$tutorial_item_equipped", 1),
	##                       (else_try),
	##                         (troop_has_item_equipped, "trp_player", itm.tutorial_crossbow),
	##                         (assign, "$tutorial_item_equipped", 1),
	##                       (else_try),
	##                         (troop_has_item_equipped, "trp_player", itm.tutorial_throwing_daggers),
	##                         (assign, "$tutorial_item_equipped", 1),
	##                       (try_end),
		...
		[
			...
			(0, 0, ti_once, [],
				[
					...
					(scene_spawned_item_get_instance, ":item_instance", itm.practice_bow, 0),
					(prop_instance_get_position, pos0, ":item_instance"),
					(position_move_z, pos0, -1000, 1),
					(prop_instance_set_position, ":item_instance", pos0),
					(scene_spawned_item_get_instance, ":item_instance", itm.practice_bow_2, 0),
					(prop_instance_get_position, pos0, ":item_instance"),
					(position_move_z, pos0, -1000, 1),
					(prop_instance_set_position, ":item_instance", pos0),
					(scene_spawned_item_get_instance, ":item_instance", itm.practice_arrows, 0),
					(prop_instance_get_position, pos0, ":item_instance"),
					(position_move_z, pos0, -1000, 1),
					(prop_instance_set_position, ":item_instance", pos0),
					(scene_spawned_item_get_instance, ":item_instance", itm.practice_arrows_2, 0),
					(prop_instance_get_position, pos0, ":item_instance"),
					(position_move_z, pos0, -1000, 1),
					(prop_instance_set_position, ":item_instance", pos0),
					(scene_spawned_item_get_instance, ":item_instance", itm.practice_crossbow, 0),
					(prop_instance_get_position, pos0, ":item_instance"),
					(position_move_z, pos0, -1000, 1),
					(prop_instance_set_position, ":item_instance", pos0),
					(scene_spawned_item_get_instance, ":item_instance", itm.practice_bolts, 0),
					(prop_instance_get_position, pos0, ":item_instance"),
					(position_move_z, pos0, -1000, 1),
					(prop_instance_set_position, ":item_instance", pos0),
					(scene_spawned_item_get_instance, ":item_instance", itm.practice_javelin, 0),
					(prop_instance_get_position, pos0, ":item_instance"),
					(position_move_z, pos0, -1000, 1),
					(prop_instance_set_position, ":item_instance", pos0),
					(scene_spawned_item_get_instance, ":item_instance", itm.arena_lance, 0),
					(prop_instance_get_position, pos0, ":item_instance"),
					(position_move_z, pos0, -1000, 1),
					(prop_instance_set_position, ":item_instance", pos0),
					]),
				...
				[
					...
					(try_for_agents, ":cur_agent"),
						...
						(try_begin),
							...
							(neq, ":cur_wielded_item", itm.practice_bow),
				...
				[
					...
					(try_for_agents, ":cur_agent"),
						...
						(else_try),
							...
							(try_begin),
								(agent_get_wielded_item, ":cur_wielded_item", ":cur_agent", 0),
								(neq, ":cur_wielded_item", itm.practice_sword),
			...
			(0, 0, 0,
				[
					...
					(assign, ":refill", 0),
					(try_begin),
						(eq, ":wielded_weapon", itm.practice_bow),
						(agent_has_item_equipped, ":player_agent", itm.practice_arrows),
						(agent_get_ammo, ":cur_ammo", ":player_agent", 1),
						(eq, ":cur_ammo", 0),
						(assign, ":refill", 1),
					(else_try),
						(eq, ":wielded_weapon", itm.practice_bow_2),
						(agent_has_item_equipped, ":player_agent", itm.practice_arrows_2),
						(agent_get_ammo, ":cur_ammo", ":player_agent", 1),
						(eq, ":cur_ammo", 0),
						(assign, ":refill", 1),
					(else_try),
						(eq, ":wielded_weapon", itm.practice_crossbow),
						(agent_has_item_equipped, ":player_agent", itm.practice_bolts),
						(agent_get_ammo, ":cur_ammo", ":player_agent", 1),
						(eq, ":cur_ammo", 0),
						(assign, ":refill", 1),
					(else_try),
						(eq, ":wielded_weapon", itm.practice_javelin),
						(agent_get_ammo, ":cur_ammo", ":player_agent", 1),
						(le, ":cur_ammo", 1),
						(assign, ":refill", 1),
					(try_end),
						...
						(try_begin),
							...
							(try_begin),
								...
								(try_for_agents, ":cur_agent"),
									...
									(eq, ":cur_agent_item", itm.practice_horse),
				...
				[
					...
					(try_begin),
						...
						(try_begin),
							...
							(try_end),
							(agent_set_wielded_item, ":trainer_agent", itm.practice_sword), #TODO: change this
			...
			(0, 0, 0,
				[
					...
					(try_begin),
						...
						(eq, ":shield_item", -1),
						(agent_get_wielded_item, ":weapon_item", ":player_agent", 0),
						(neq, ":weapon_item", itm.practice_dagger),
						(call_script, "script_cf_is_melee_weapon_for_tutorial", ":weapon_item"),
						(store_mission_timer_a, ":cur_time"),
						(gt, ":cur_time", "$g_tutorial_training_ground_next_score_time"),
						(val_add, "$g_tutorial_training_ground_current_score", 1),
		...
		[
			...
			(0, 0, 0, [(try_begin),
					...
					(else_try),
						...
						(try_end),
						(get_player_agent_no, ":player_agent"),
						(agent_has_item_equipped, ":player_agent", itm.tutorial_sword),
	...
	(
		...
		[
			...
			(0, 0, 0, [(try_begin),
						...
						(get_player_agent_no, ":player_agent"),
						(ge, ":player_agent", 0),
						(agent_has_item_equipped, ":player_agent", itm.tutorial_staff_no_attack),
				...
				[
					...
					(try_for_range, ":player_no", 0, ":num_players"),
						...
						(try_begin),
							...
							(this_or_next|eq, ":item_id", itm.warhorse_sarranid),
		...
		[
			...
			(ti_on_agent_hit, 0, 0, [(multiplayer_is_server),],
				[
					...
					(else_try),
						(eq, reg0, itm.blood_drain_throwing_knives),
					...
					(else_try),
						...
						(try_end),
					(else_try),
						(eq, reg0, itm.disarming_throwing_axe),
						(try_begin),
							(agent_is_human, ":agent_no"),
					...
					(else_try),
						...
						(try_begin),
							...
							(eq, ":agent_boots", itm.kicking_boots),
							(store_agent_hit_points, ":agent_health", ":agent_no", 1),
					...
					(else_try),
						...
						(try_end),
					(else_try),
						(eq, reg0, itm.weak_beserker_dart),
						#(store_trigger_param_2, ":attacker_no"),
						...
						#      (add_missile, ":attacker_no", pos2, 90, itm.scatter_crossbow, 0, itm.scatter_bolts, 0),
						#
						#    (try_end),
						#  (try_end),
					(try_end),
			...
			(2, 0, 0, [(multiplayer_is_server),],
				[
					...
					(try_for_agents, ":agent_no"),
						...
						(try_begin),
							(eq, ":body_armour", itm.restore_health_armour),
							(store_agent_hit_points, ":agent_health", ":agent_no", 1),
